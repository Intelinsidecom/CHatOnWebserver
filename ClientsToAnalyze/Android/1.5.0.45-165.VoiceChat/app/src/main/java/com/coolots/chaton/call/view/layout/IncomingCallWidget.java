...
public class IncomingCallWidget extends RelativeLayout implements DisposeInterface {
    ...
    public IncomingCallWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.VIBRATE_SHORT = 30L;
        this.VIBRATE_LONG = 40L;
        this.mGrabbedState = 0;
    ...
    public IncomingCallWidget(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        this.mLeftHandle.mTab.setContentDescription(ContentDescriptionStringMaker.makeString(C0000R.string.call_swipe_right_message, C0000R.string.slide_to_answer_hint));
        this.mRightHandle.mTab.setContentDescription(ContentDescriptionStringMaker.makeString(C0000R.string.call_swipe_left_message, C0000R.string.slide_to_decline_hint));
        this.mHandlerDispose = false;
    }

    public void airCallSweepRight() {
        this.mLeftHandle.gestureSweep();
    }

    public void airCallHandShape() {
        this.mLeftHandle.gestureHandShape();
    }

    public boolean airCallAnimationOver() {
        return this.mLeftHandle.animationOver;
    }
    ...
    public class Handle {
        ...
        private ImageView mTabCircleImage;
        ...
        final int ARROW_COUNT = 4;
        private Handler mHandler = new Handler() { // from class: com.coolots.chaton.call.view.layout.IncomingCallWidget.Handle.1
            @Override // android.os.Handler
            public void handleMessage(Message msg) {
                if (!IncomingCallWidget.this.mHandlerDispose) {
                    IncomingCallWidget.this.logI("handleMessage");
                    switch (msg.what) {
                        case 100:
                            if (Handle.this.mArrowContainer.isShown()) {
                                ImageView arrowImage = null;
                                for (int i = 0; i < 4; i++) {
                                    int index = Handle.this.mHandleType == 1 ? i : (4 - i) - 1;
        ...
        private void init() {
            ...
            IncomingCallWidget.this.logI(" Handle ; init!");
            this.mCurrentState = 0;
            this.mContainer = new FrameLayout(this.mContext) { // from class: com.coolots.chaton.call.view.layout.IncomingCallWidget.Handle.2
                @Override // android.view.View
                protected void onWindowVisibilityChanged(int visibility) {
                    IncomingCallWidget.this.logI("onWindowVisibilityChanged visibility : " + visibility);
            ...
            int diameter = (Math.min(metrics.widthPixels, metrics.heightPixels) * 889) / 1000;
            if (PhoneFeature.hasFeature(1)) {
            ...
            this.mTabCircleImage = new ImageView(this.mContext);
            FrameLayout.LayoutParams mTabCircleLp = new FrameLayout.LayoutParams((diameter * 163) / 200, (diameter * 163) / 200, 17);
            this.mTabCircleImage.setLayoutParams(mTabCircleLp);
            this.mContainer.addView(this.mTabCircleImage, mTabCircleLp);
            this.mTab = new ImageView(this.mContext);
            FrameLayout.LayoutParams mTabLp = new FrameLayout.LayoutParams((diameter * 17) / 100, (diameter * 17) / 100, 17);
            this.mTab.setLayoutParams(mTabLp);
            this.mContainer.addView(this.mTab, mTabLp);
            if (this.mHandleType == 1) {
                containerParams.addRule(9);
                this.mTab.setBackgroundResource(C0000R.drawable.ic_jog_dial_answer);
                this.mTabCircleImage.setImageResource(C0000R.drawable.jog_tab_left_bg_press_small);
                this.mCircleColor = -12087541;
            } else if (this.mHandleType == 2) {
                containerParams.addRule(11);
                this.mTab.setBackgroundResource(C0000R.drawable.ic_jog_dial_decline);
                this.mTabCircleImage.setImageResource(C0000R.drawable.unlock_right_press_small);
                this.mCircleColor = -3464677;
            }
            if (PhoneFeature.hasFeature(1)) {
                this.mTabCircle = new TabCircle(this.mContext, (diameter * 8.0f) / 50.0f);
            } else {
                this.mTabCircle = new TabCircle(this.mContext, (diameter * 3.0f) / 20.0f);
            }
            this.mTabCircle.setVisibility(0);
            this.mTabCircleImage.setVisibility(0);
            this.mContainer.addView(this.mTabCircle, layoutParams);
            makeArrowViews(this.mContainer, diameter);
            this.mTargetCircle = new TargetCircle(this.mContext, (diameter * 22) / 44);
            ...
            if (PhoneFeature.hasFeature(2)) {
                if (IncomingCallWidget.this.getResources().getConfiguration().orientation == 2) {
            ...
            if (this.mHandleType == 1) {
                this.mTab.setContentDescription(this.mContext.getText(C0000R.string.slide_to_answer_hint));
                this.mTab.setClickable(true);
            } else if (this.mHandleType == 2) {
                this.mTab.setContentDescription(this.mContext.getText(C0000R.string.slide_to_decline_hint));
                this.mTab.setClickable(true);
            }
        }
        ...
        private void makeArrowViews(FrameLayout container, int diameter) {
            ...
            this.mArrowImageViews = new ImageView[4];
            int layoutGravity = 0;
            LinearLayout.LayoutParams paddingLp = new LinearLayout.LayoutParams((diameter * 1) / 25, (diameter * 1) / 20, VLSpotterContext.DEFAULT_PHRASESPOT_AOFFSET);
            LinearLayout.LayoutParams arrowLp = new LinearLayout.LayoutParams((diameter * 3) / 100, (diameter * 1) / 20);
            for (int i = 0; i < 4; i++) {
                this.mArrowImageViews[i] = new ImageView(this.mContext);
                if (this.mHandleType == 1) {
                    arrowResId = C0000R.drawable.arrow_g;
                    layoutGravity = 21;
                    alpha = (int) (255.0f * (1.0f - ((20.0f * ((4 - i) - 1)) / 100.0f)));
                    if (i != 0) {
                ...
                this.mArrowImageViews[i].setLayoutParams(arrowLp);
            ...
            if (PhoneFeature.hasFeature(4)) {
                if (this.mHandleType == 1) {
                    lp.rightMargin = (diameter * 11) / 139;
                    lp.bottomMargin = (diameter * 2) / 59;
                    lp.topMargin = 0;
                } else {
                    lp.leftMargin = (diameter * 11) / 139;
                    lp.bottomMargin = 0;
                    lp.topMargin = (diameter * 2) / 59;
                }
            } else if (this.mHandleType == 1) {
                lp.rightMargin = (diameter * 10) / 139;
            } else {
                lp.leftMargin = (diameter * 10) / 139;
            }
        ...
        public void makeLayout() {
            ...
            int marginX = 0;
            if (PhoneFeature.hasFeature(4)) {
                marginX = (IncomingCallWidget.this.mDisplayMetrics.densityDpi * 100) / 160;
            }
            if (this.mHandleType == 1) {
                int leftHandleLeft = this.mContainer.getLeft() - marginX;
                int leftHandleTop = this.mContainer.getTop() + (this.mContainer.getHeight() / 10);
                this.mContainer.layout(leftHandleLeft, leftHandleTop - 0, this.mContainer.getWidth() + leftHandleLeft, (this.mContainer.getHeight() + leftHandleTop) - 0);
            } else if (this.mHandleType == 2) {
                ...
                this.mContainer.layout(rightHandleLeft, rightHandleTop - 0, this.mContainer.getWidth() + rightHandleLeft, (this.mContainer.getHeight() + rightHandleTop) - 0);
            }
            IncomingCallWidget.this.logI("mDisplayMetrics " + IncomingCallWidget.this.mDisplayMetrics);
        }
        ...
        public void tabletMakeLayout() {
            ...
            Configuration config = IncomingCallWidget.this.getResources().getConfiguration();
        ...
        public void setState(int newState, boolean animation) {
            if (this.mHandler.hasMessages(200)) {
                IncomingCallWidget.this.logI("Block setState until reset. Handles will be reset");
            }
            int preState = this.mCurrentState;
            this.mCurrentState = newState;
            IncomingCallWidget.this.logI("HANDLE : " + this.mCurrentState + " setState preState " + preState + " Current : " + this.mCurrentState);
        ...
        public void gestureSweep() {
            AnimationSet aniSet = new AnimationSet(true);
            this.animationOver = false;
            ScaleAnimation scaleAni = new ScaleAnimation(0.3f, 1.0f, 0.3f, 1.0f, this.mTabCircle.getWidth() / 2, this.mTabCircle.getWidth() / 2);
            aniSet.addAnimation(scaleAni);
            AlphaAnimation alphaAni = new AlphaAnimation(VLSpotterContext.DEFAULT_PHRASESPOT_AOFFSET, 1.0f);
            aniSet.addAnimation(alphaAni);
            TranslateAnimation transAni = new TranslateAnimation(2, 0.03f, 2, -0.03f, 2, -0.03f, 2, 0.03f);
            transAni.setRepeatMode(2);
            transAni.setRepeatCount(3);
            aniSet.setDuration(400L);
            transAni.setDuration(400L);
            transAni.setAnimationListener(new Animation.AnimationListener() { // from class: com.coolots.chaton.call.view.layout.IncomingCallWidget.Handle.3
                ...
                public void onAnimationEnd(Animation animation) {
                    Handle.this.reset(true);
                }
            });
            this.mTab.startAnimation(transAni);
        ...
        public void gestureHandShape() {
            IncomingCallWidget.this.mOnTriggerListener.onReceiveCall();
        }
        ...
        public void reset(boolean animation) {
            ...
            this.mTabCircleImage.setAlpha(255);
            this.mTabCircle.invalidate();
            this.mTabCircleImage.invalidate();
            this.mTabCircle.setVisibility(0);
            this.mTabCircleImage.setVisibility(0);
            showArrow();
        }
        ...
        private void setDisable() {
            ...
            this.mTabCircleImage.setVisibility(4);
            hideArrow();
        }
        ...
        public void processMoveEvent(MotionEvent motion) {
            if (this.mCurrentState == 1) {
                ...
                if (this.mTargetCircle.isThresholdReached(x, y)) {
                    ...
                    this.mTargetCircle.invalidate();
                    this.mTabCircleImage.setAlpha(0);
                    this.mTabCircle.invalidate();
                    this.mTabCircleImage.invalidate();
                ...
                this.mTabCircleImage.setAlpha(255 - ((int) (255.0d * ratio)));
        ...
        public void tabletProcessMoveEvent(MotionEvent motion) {
            if (this.mCurrentState == 1) {
                ...
                if (currentRatio < 0.95d) {
                    IncomingCallWidget.this.logI("Not reach the target circle, set Circle's alpha value");
                    if (this.mTabCircle.isInCircle(x, y)) {
                        showArrow();
                    } else {
                        hideArrow();
                    }
                    this.mTabCircleImage.setAlpha(255 - ((int) (255.0d * currentRatio)));
                ...
                if (currentRatio < 0.95d || currentRatio > 2.5d) {
                    IncomingCallWidget.this.logI(" Go over the valid region, set the State as Normal");
                    this.mHandler.postDelayed(new Runnable() { // from class: com.coolots.chaton.call.view.layout.IncomingCallWidget.Handle.5
                ...
                IncomingCallWidget.this.logI(" Reach the valid region, let's call dispatchTriggerEvent()");
                this.mTargetCircle.clearAnimation();
                this.mTabCircle.clearAnimation();
                this.mTargetCircle.setAlpha(255);
                this.mTargetCircle.invalidate();
                ...
                IncomingCallWidget.this.dispatchTriggerEvent(this.mHandleType);
                IncomingCallWidget.this.setGrabbedState(0);
                this.mHandler.postDelayed(new Runnable() { // from class: com.coolots.chaton.call.view.layout.IncomingCallWidget.Handle.4
                    @Override // java.lang.Runnable
                    public void run() {
                        IncomingCallWidget.this.mLeftHandle.setState(0);
                        IncomingCallWidget.this.mRightHandle.setState(0);
        ...
        public boolean isHandleSelected(float x, float y) {
            ...
            IncomingCallWidget.this.logI("mTopOffset : " + this.mTopOffset);
        ...
        public class TabCircle extends View {
            ...
            private void init(float radius) {
                ...
                if (!PhoneFeature.hasFeature(1)) {
                    if (IncomingCallWidget.this.mDisplayMetrics.densityDpi == 160) {
            ...
            public boolean isInCircle(float x, float y) {
                ...
                IncomingCallWidget.this.logI("isInCircle - x : " + x + " y : " + y + " ratio : " + ratio);
                return ratio < 1.3d;
            }
            ...
            public boolean dispatchGenericMotionEvent(MotionEvent event) {
                IncomingCallWidget.this.logD("dispatchGenericMotionEvent : event = " + event);
                int action = event.getAction();
