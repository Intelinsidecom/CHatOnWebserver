...
import com.coolots.chaton.call.view.layout.IncomingCallWidget;
...
public class IncomingSlidingWidget extends RelativeLayout implements IncomingCallWidget.OnTriggerListener, View.OnClickListener, DisposeInterface {
    public static final String CLASSNAME = "[IncomingSlidingWidget]";
    private static final int IN_CALL_WIDGET_TRANSITION_TIME = 250;
    private boolean bDispose;
    private CallDisplayUserInfo mCalluserInfo;
    private Context mContext;
    private Destination mDestination;
    public IncomingCallWidget mIncomingSlidingTab;
    ...
    public IncomingSlidingWidget(Context context, ViewGroup r) {
        super(context);
        this.mContext = null;
        this.mIsUsim = true;
        ...
        this.mViewGrouproot = (ViewGroup) inflater.inflate(C0000R.layout.incoming_sliding_widget, r, true);
        this.mViewGrouproot.getChildAt(childViewCount).setTag(String.valueOf(getClass().toString()) + getConfiguration());
        this.receiveCall = false;
    }

    public IncomingSlidingWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = null;
        this.mIsUsim = true;
        this.mOpenRejectMsg = false;
    ...
    private void linkControls() {
        if (this.mViewGrouproot != null) {
            this.mIncomingSlidingTab = (IncomingCallWidget) this.mViewGrouproot.findViewById(C0000R.id.incomingCallWidget);
            ...
            if (this.mIsUsim) {
                this.mRejectCallWithMsgDrawer = (SlidingDrawer) this.mViewGrouproot.findViewById(C0000R.id.reject_call_with_msg_container);
                this.mRejectCallWithMsgHandle = (Button) this.mViewGrouproot.findViewById(C0000R.id.reject_call_with_msg_handle);
                this.mRejectCallWithMsgDrawer.setOnDrawerOpenListener(new SlidingDrawer.OnDrawerOpenListener() { // from class: com.coolots.chaton.call.view.layout.IncomingSlidingWidget.1
                    @Override // android.widget.SlidingDrawer.OnDrawerOpenListener
                    public void onDrawerOpened() {
                        if (!IncomingSlidingWidget.this.bDispose) {
                            IncomingSlidingWidget.this.mIncomingSlidingTab.setFocusable(false);
                            if (IncomingSlidingWidget.this.mRejectCallWithMsgHandle != null) {
                                boolean isPortrate = MainApplication.mContext.getResources().getConfiguration().orientation == 1;
                                IncomingSlidingWidget.this.mOpenRejectMsg = true;
                                if (isPortrate) {
                                    IncomingSlidingWidget.this.mRejectCallWithMsgHandle.setBackgroundResource(C0000R.drawable.reject_call_selector_down);
                                } else {
                                    IncomingSlidingWidget.this.mRejectCallWithMsgHandle.setBackgroundResource(C0000R.drawable.reject_call_selector_down_h);
                                }
                            }
                        }
                    }
                });
                this.mRejectCallWithMsgDrawer.setOnDrawerCloseListener(new SlidingDrawer.OnDrawerCloseListener() { // from class: com.coolots.chaton.call.view.layout.IncomingSlidingWidget.2
                    @Override // android.widget.SlidingDrawer.OnDrawerCloseListener
                    public void onDrawerClosed() {
                        if (!IncomingSlidingWidget.this.bDispose) {
                            IncomingSlidingWidget.this.mIncomingSlidingTab.setFocusable(true);
                            if (IncomingSlidingWidget.this.mRejectCallWithMsgHandle != null) {
                                boolean isPortrate = MainApplication.mContext.getResources().getConfiguration().orientation == 1;
                                IncomingSlidingWidget.this.mOpenRejectMsg = false;
                                if (isPortrate) {
                                    IncomingSlidingWidget.this.mRejectCallWithMsgHandle.setBackgroundResource(C0000R.drawable.reject_call_selector);
                                } else {
                                    IncomingSlidingWidget.this.mRejectCallWithMsgHandle.setBackgroundResource(C0000R.drawable.reject_call_selector_h);
                                }
                            }
                        }
                    }
                });
                this.mRejectCallWithMsgLayout = (RejectCallWithMsgLayout) this.mViewGrouproot.findViewById(C0000R.id.reject_call_with_msg_content);
                this.mRejectCallWithMsgLayout.setCallInfo(this.mParentActivity, this.mPhoneNumber, this.mDestination, this.mCalluserInfo);
            }
            this.mReceiveBtn = (Button) this.mViewGrouproot.findViewById(C0000R.id.btn_receive);
            this.mReceiveBtn.setOnClickListener(this);
            return;
        }
        this.mIncomingSlidingTab = (IncomingCallWidget) findViewById(C0000R.id.incomingCallWidget);
        this.mIncomingSlidingTab.setLeftHintText(C0000R.string.calling_button_receive);
        this.mIncomingSlidingTab.setRightHintText(C0000R.string.calling_button_hang_up);
        this.mIncomingSlidingTab.setOnTriggerListener(this);
        if (this.mIsUsim) {
            ...
            this.mRejectCallWithMsgDrawer.setOnDrawerOpenListener(new SlidingDrawer.OnDrawerOpenListener() { // from class: com.coolots.chaton.call.view.layout.IncomingSlidingWidget.3
                @Override // android.widget.SlidingDrawer.OnDrawerOpenListener
                public void onDrawerOpened() {
                    if (!IncomingSlidingWidget.this.bDispose) {
                        IncomingSlidingWidget.this.mIncomingSlidingTab.setFocusable(false);
            ...
            this.mRejectCallWithMsgDrawer.setOnDrawerCloseListener(new SlidingDrawer.OnDrawerCloseListener() { // from class: com.coolots.chaton.call.view.layout.IncomingSlidingWidget.4
                @Override // android.widget.SlidingDrawer.OnDrawerCloseListener
                public void onDrawerClosed() {
                    if (!IncomingSlidingWidget.this.bDispose) {
                        IncomingSlidingWidget.this.mIncomingSlidingTab.setFocusable(true);
    ...
    public void initialize(CallActivity parent, Destination destination, CallDisplayUserInfo info) {
        if (this.mViewGrouproot == null) {
            ...
            inflater.inflate(C0000R.layout.incoming_sliding_widget, (ViewGroup) this, true);
        }
    ...
    public void setDestination(Destination destination) {
        this.mDestination = destination;
        getPhoneNumber(destination);
        if (this.mIsUsim && this.mRejectCallWithMsgLayout != null) {
            this.mRejectCallWithMsgLayout.setCallInfo(this.mParentActivity, this.mPhoneNumber, this.mDestination, this.mCalluserInfo);
        }
    }
    ...
    private void hideIncomingCallWidget() {
        if (this.mIncomingSlidingTab.getVisibility() == 0 && this.mIncomingSlidingTab.getAnimation() == null) {
            if (this.mSlidingTabAnim == null) {
                ...
                this.mSlidingTabAnim.setAnimationListener(new Animation.AnimationListener() { // from class: com.coolots.chaton.call.view.layout.IncomingSlidingWidget.5
                    ...
                    public void onAnimationEnd(Animation animation) {
                        IncomingSlidingWidget.this.mIncomingSlidingTab.clearAnimation();
                        IncomingSlidingWidget.this.mIncomingSlidingTab.setVisibility(8);
                    }
                });
            }
    ...
    @Override // com.coolots.chaton.call.view.layout.IncomingCallWidget.OnTriggerListener
    public void onTrigger(View view, int whichHandle) {
        switch (whichHandle) {
            case 1:
                hideIncomingCallWidget();
                this.mLastIncomingCallActionTime = SystemClock.uptimeMillis();
                if (this.mParentActivity != null && !this.receiveCall) {
    ...
    public void airCallSweepRight() {
        this.mIncomingSlidingTab.airCallSweepRight();
    }

    public void airCallHandShape() {
        this.mIncomingSlidingTab.airCallHandShape();
    }
