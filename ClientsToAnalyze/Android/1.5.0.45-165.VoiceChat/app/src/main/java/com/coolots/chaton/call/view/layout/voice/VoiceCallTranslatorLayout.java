...
public class VoiceCallTranslatorLayout extends FrameLayout implements DisposeInterface {
    ...
    public VoiceCallTranslatorLayout(Context context, ViewGroup r) {
        super(context);
        this.mHoldOnOff = false;
        this.mTTSOnOff = false;
        this.mTranslatorHelpHandler = new TranslatorHelpHandler();
        this.mButtonClickListener = new View.OnClickListener() { // from class: com.coolots.chaton.call.view.layout.voice.VoiceCallTranslatorLayout.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                switch (view.getId()) {
                    case C0000R.id.translator_tts /* 2131493546 */:
                        VoiceCallTranslatorLayout.this.mTTSOnOff = !VoiceCallTranslatorLayout.this.mTTSOnOff;
                        break;
                }
                VoiceCallTranslatorLayout.this.setUI(view);
                VoiceCallTranslatorLayout.this.setCommand(view);
            }
        };
        ...
        this.mTranslatorChangeLanguageHelpToast = (LinearLayout) this.mRootGroupView.findViewById(C0000R.id.translator_change_languae_help);
    ...
    protected class TranslatorHelpHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    VoiceCallTranslatorLayout.this.mTranslatorChangeLanguageHelpToast.setVisibility(8);
                    break;
                case 1:
                    VoiceCallTranslatorLayout.this.mTranslatorChangeLanguageHelpToast.setVisibility(0);
                    break;
            }
        }
    }
