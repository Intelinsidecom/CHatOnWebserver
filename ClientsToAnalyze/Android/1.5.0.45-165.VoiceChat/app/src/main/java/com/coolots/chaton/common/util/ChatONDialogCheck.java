...
public class ChatONDialogCheck extends Dialog implements DialogInterface {
    public ChatONDialogCheck(Context context, int theme) {
        super(context, theme);
    }

    public ChatONDialogCheck(Context context) {
        super(context);
    }
    ...
    public static class Builder {
        ...
        public ChatONDialogCheck show() {
            ChatONDialogCheck dialog = create();
            dialog.show();
            return dialog;
        }

        public void setDoNotShowAgainPrefKey(String prefKey) {
        ...
        public ChatONDialogCheck create() {
            LayoutInflater inflater = (LayoutInflater) this.context.getSystemService("layout_inflater");
            final ChatONDialogCheck dialog = new ChatONDialogCheck(this.context, C0000R.style.Dialog);
            View layout = inflater.inflate(C0000R.layout.chatonv_custom_dialog_check, (ViewGroup) null);
            ...
            if (this.positiveButtonText != null) {
                ...
                if (this.positiveButtonClickListener != null) {
                    ((Button) layout.findViewById(C0000R.id.general_dialog_positive_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.coolots.chaton.common.util.ChatONDialogCheck.Builder.1
            ...
            if (this.negativeButtonText != null) {
                ...
                if (this.negativeButtonClickListener != null) {
                    ((Button) layout.findViewById(C0000R.id.general_dialog_negative_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.coolots.chaton.common.util.ChatONDialogCheck.Builder.2
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
            ...
            if (this.neutralButtonText != null) {
                ...
                if (this.neutralButtonClickListener != null) {
                    ((Button) layout.findViewById(C0000R.id.general_dialog_cancel_btn)).setOnClickListener(new View.OnClickListener() { // from class: com.coolots.chaton.common.util.ChatONDialogCheck.Builder.3
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
            ...
            CheckBox checkBox = (CheckBox) layout.findViewById(C0000R.id.chaton_custom_check_box);
            checkBox.setChecked(ChatONSettingData.getInstance().isChecked(this.mPrefKey));
            checkBox.setOnClickListener(new View.OnClickListener() { // from class: com.coolots.chaton.common.util.ChatONDialogCheck.Builder.4
                @Override // android.view.View.OnClickListener
                public void onClick(View arg0) {
                    if (Builder.this.mPrefKey != null && !Builder.this.mPrefKey.isEmpty()) {
                        boolean isChecked = ChatONSettingData.getInstance().isChecked(Builder.this.mPrefKey);
                        ChatONSettingData.getInstance().setChecked(Builder.this.mPrefKey, !isChecked);
                    }
                }
            });
