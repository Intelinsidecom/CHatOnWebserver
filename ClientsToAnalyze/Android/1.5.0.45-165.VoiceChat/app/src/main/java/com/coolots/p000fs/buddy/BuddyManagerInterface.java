package com.coolots.p000fs.buddy;
...
public interface BuddyManagerInterface extends ContactManagerInterface {
    ...
    boolean isBlockUserForCall(String str, Destination destination, int i, boolean z, boolean z2, boolean z3, boolean z4, String str2, Date date, BlockCallHandler blockCallHandler);
