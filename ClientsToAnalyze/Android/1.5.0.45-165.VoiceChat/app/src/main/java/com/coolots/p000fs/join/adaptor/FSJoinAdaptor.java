package com.coolots.p000fs.join.adaptor;
...
public class FSJoinAdaptor extends HttpAdaptor implements DisposeInterface {
    public FSJoinAdaptor(FamilyStoryJoinAsk ask, Handler handler) {
        super(MessageInfo.FamilyStoryJoinAsk, ask, handler, 6000);
    }

    @Override // com.sds.coolots.common.httpAdaptor.HttpAdaptor
    protected void setUserInfo() {
        FamilyStoryJoinAsk ask = (FamilyStoryJoinAsk) getMsgBody();
