package com.coolots.sse.join.adaptor;
...
public class SSEJoinAdaptor extends HttpAdaptor implements DisposeInterface {
    public SSEJoinAdaptor(SSEJoinAsk ask, Handler handler) {
        super(MessageInfo.SSEJoinAsk, ask, handler, 6000);
    }

    @Override // com.sds.coolots.common.httpAdaptor.HttpAdaptor
    protected void setUserInfo() {
        SSEJoinAsk ask = (SSEJoinAsk) getMsgBody();
    ...
    protected void processRecvMessage(P2PMsg p2pMsg) {
        ...
        if (msgBody instanceof SSEJoinRep) {
