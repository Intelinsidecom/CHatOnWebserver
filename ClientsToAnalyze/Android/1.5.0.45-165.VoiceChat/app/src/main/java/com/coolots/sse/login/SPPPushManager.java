...
public class SPPPushManager extends PushManager {
    ...
    public static String EP_ID_SPP = "c523f78424aed530";
    ...
    private final ServiceConnection mPushClientConnection = new ServiceConnection() { // from class: com.coolots.sse.login.SPPPushManager.1
    ...
    public void sendRegisterMessage() {
        ...
        intent.putExtra("appId", EP_ID_SPP);
        Log.m2958e("<<SPP>> sse packageName:" + MainApplication.mContext.getPackageName());
        Log.m2958e("<<SPP>> sse APPID :" + EP_ID_SPP);
        intent.putExtra(Config.EXTRA_USERDATA, MainApplication.mContext.getPackageName());
        MainApplication.mContext.sendBroadcast(intent);
    }
}
