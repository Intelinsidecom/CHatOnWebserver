...
public class SandPaper implements SpenObjectRuntimeInterface {
    ...
    public void start(Object objectBase, RectF relativeRect, PointF pan, float zoomRatio, PointF frameStartPosition, ViewGroup viewGroup) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (filePath == null) {
            if (this.mPhysicsView == null && !IsRunning.booleanValue()) {
                ...
                this.mDummyView.setOnTouchListener(new View.OnTouchListener() { // from class: com.samsung.android.sdk.pen.objectruntime.preload.SandPaper.1
                ...
                this.mPhysicsRenderer = new PhysicsRenderer(this.mContext, this.mPhysicsView, 0);
                this.mPhysicsView.setPhysicsRenderer(this.mPhysicsRenderer);
                IsRunning = true;
                PhysicsRenderer.OnCompleteSandFrameListener listener = new PhysicsRenderer.OnCompleteSandFrameListener() { // from class: com.samsung.android.sdk.pen.objectruntime.preload.SandPaper.2
                    @Override // com.samsung.android.sdk.pen.objectruntime.preload.PhysicsRenderer.OnCompleteSandFrameListener
                    public void OnCompleteSandFrameListener(Bitmap bitmap, int mode) {
                        SandPaper.this.m3DBitmap = bitmap;
                    }
                };
    ...
    public void stop(boolean objectRuntimeStopFlag) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (IsRunning.booleanValue() && this.mPhysicsRenderer != null) {
            ...
            if (this.m3DBitmap == null) {
                Log.e("mytag", "[SandPaperActiveObject] onUnselected() - Capture image is nuLLLLLLLLLLLLLLLLLLLLLLLL");
            }
    ...
    private void setImage(Bitmap bitmap) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (mSetImage != null) {
