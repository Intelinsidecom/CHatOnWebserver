...
public class ChineseBrush implements SpenPenInterface {
    private Bitmap mBitmap;
    public final int nativeChineseBrush = native_init();
    ...
    public void onUnload() {
        this.mBitmap = null;
        native_onUnload(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPluginInterface
    public void setProperty(Bundle propertyMap) {
        native_setProperty(this.nativeChineseBrush, propertyMap);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPluginInterface
    public void getProperty(Bundle propertyMap) {
        native_getProperty(this.nativeChineseBrush, propertyMap);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenNativeHandleInterface
    public int getNativeHandle() {
        return this.nativeChineseBrush;
    }
    ...
    public void draw(MotionEvent event, RectF rect) {
        if (this.mBitmap != null) {
            ...
            if (!native_draw(this.nativeChineseBrush, event, rect, event.getToolType(0))) {
    ...
    public void redrawPen(MotionEvent allEvent, RectF rect) {
        if (this.mBitmap != null) {
            ...
            this.mBitmap.setPixel(0, 0, 0);
            if (!native_redraw(this.nativeChineseBrush, allEvent, rect, allEvent.getToolType(0))) {
                SpenError.ThrowUncheckedException(SpenError.getError(), toString());
            }
        }
    }
    ...
    public void setBitmap(Bitmap bitmap) {
        this.mBitmap = bitmap;
        if (this.mBitmap != null && !native_setBitmap(this.nativeChineseBrush, this.mBitmap)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public void setSize(float size) {
        if (!native_setSize(this.nativeChineseBrush, size)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public float getSize() {
        return native_getSize(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public float getMinSettingValue() {
        return native_getMinSettingValue(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public float getMaxSettingValue() {
        return native_getMaxSettingValue(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setColor(int color) {
        if (!native_setColor(this.nativeChineseBrush, color)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public int getColor() {
        return native_getColor(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setCurveEnabled(boolean curve) {
        if (!native_setCurveEnabled(this.nativeChineseBrush, curve)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public boolean isCurveEnabled() {
        return native_isCurveEnabled(this.nativeChineseBrush);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setAdvancedSetting(String advancedSetting) {
        if (!native_setAdvancedSetting(this.nativeChineseBrush, advancedSetting)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public String getAdvancedSetting() {
        return native_getAdvancedSetting(this.nativeChineseBrush);
    }
    ...
    public RectF getStrokeRect(PointF[] points, float[] pressures, int[] timestamps, float size, boolean isCurvable, String advanced) {
        return native_getStrokeRect(this.nativeChineseBrush, points, pressures, timestamps, size, isCurvable, advanced);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public boolean getPenAttribute(int attribute) {
        return native_getPenAttribute(this.nativeChineseBrush, attribute);
    }
}
