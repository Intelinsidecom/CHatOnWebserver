...
public class MagicPen implements SpenPenInterface {
    private Bitmap mBitmap;
    public final int nativeMagicPen = native_init();
    ...
    public void draw(MotionEvent event, RectF rect) {
        if (this.mBitmap != null) {
            ...
            if (!native_draw(this.nativeMagicPen, event, rect, event.getToolType(0))) {
    ...
    public void redrawPen(MotionEvent allEvent, RectF rect) {
        if (this.mBitmap != null) {
            ...
            this.mBitmap.setPixel(0, 0, 0);
            if (!native_redraw(this.nativeMagicPen, allEvent, rect, allEvent.getToolType(0))) {
                SpenError.ThrowUncheckedException(SpenError.getError(), toString());
            }
        }
    }
    ...
    public void setBitmap(Bitmap bitmap) {
        this.mBitmap = bitmap;
        if (this.mBitmap != null && !native_setBitmap(this.nativeMagicPen, this.mBitmap)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public void setReferenceBitmap(Bitmap bitmap) {
        native_setReferenceBitmap(this.nativeMagicPen, bitmap);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setSize(float size) {
        if (!native_setSize(this.nativeMagicPen, size)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public float getSize() {
        return native_getSize(this.nativeMagicPen);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public float getMinSettingValue() {
        return native_getMinSettingValue(this.nativeMagicPen);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public float getMaxSettingValue() {
        return native_getMaxSettingValue(this.nativeMagicPen);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setColor(int color) {
        if (!native_setColor(this.nativeMagicPen, color)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public int getColor() {
        return native_getColor(this.nativeMagicPen);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setCurveEnabled(boolean curve) {
        if (!native_setCurveEnabled(this.nativeMagicPen, curve)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public boolean isCurveEnabled() {
        return native_isCurveEnabled(this.nativeMagicPen);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public void setAdvancedSetting(String advancedSetting) {
        if (!native_setAdvancedSetting(this.nativeMagicPen, advancedSetting)) {
            SpenError.ThrowUncheckedException(SpenError.getError(), toString());
        }
    }
    ...
    public String getAdvancedSetting() {
        return native_getAdvancedSetting(this.nativeMagicPen);
    }
    ...
    public RectF getStrokeRect(PointF[] points, float[] pressures, int[] timestamps, float size, boolean isCurvable, String advanced) {
        return native_getStrokeRect(this.nativeMagicPen, points, pressures, timestamps, size, isCurvable, advanced);
    }

    @Override // com.samsung.android.sdk.pen.plugin.interfaces.SpenPenInterface
    public boolean getPenAttribute(int attribute) {
        return native_getPenAttribute(this.nativeMagicPen, attribute);
    }
}
