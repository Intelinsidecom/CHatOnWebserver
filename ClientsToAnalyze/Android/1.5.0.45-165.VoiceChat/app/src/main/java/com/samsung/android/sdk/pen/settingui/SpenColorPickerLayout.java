...
class SpenColorPickerLayout extends View {
    ...
    public SpenColorPickerLayout(Context context, RelativeLayout canvasLayout, float ratio, int x, int y) {
        super(context);
        ...
        this.mLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: com.samsung.android.sdk.pen.settingui.SpenColorPickerLayout.1
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                try {
                    if (SpenColorPickerLayout.this.mSpuitSettings != null && SpenColorPickerLayout.this.mSpuitSettings.getVisibility() != 8 && top != bottom) {
        ...
        this.mSpoidSettingListener = new View.OnTouchListener() { // from class: com.samsung.android.sdk.pen.settingui.SpenColorPickerLayout.2
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case 0:
                        RelativeLayout.LayoutParams spoidSettingParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mColorPickerHandle.getLayoutParams();
                        SpenColorPickerLayout.this.mXDelta = x2 - spoidSettingParams.leftMargin;
                        SpenColorPickerLayout.this.mYDelta = y2 - spoidSettingParams.topMargin;
                        break;
                    case 2:
                        RelativeLayout.LayoutParams spoidSettinghandleParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mColorPickerHandle.getLayoutParams();
                        RelativeLayout.LayoutParams spoidSettingBgParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mSpuitdBG.getLayoutParams();
                        RelativeLayout.LayoutParams spoidColorImageParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mColorPickerColorImage.getLayoutParams();
                        RelativeLayout.LayoutParams spoidExitBtnParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mColorPickerdExitBtn.getLayoutParams();
                        RelativeLayout.LayoutParams spuitCurrentColorParams = (RelativeLayout.LayoutParams) SpenColorPickerLayout.this.mColorPickerCurrentColor.getLayoutParams();
                        spoidSettinghandleParams.leftMargin = x2 - SpenColorPickerLayout.this.mXDelta;
                        spoidSettinghandleParams.topMargin = y2 - SpenColorPickerLayout.this.mYDelta;
                        ...
                        int minWidth = SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(106.0f);
                        int minHeight = SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(38.0f);
                        if (spoidSettinghandleParams.leftMargin > SpenColorPickerLayout.this.mParentRelativeLayout.getWidth() - minWidth) {
                            spoidSettinghandleParams.leftMargin = SpenColorPickerLayout.this.mParentRelativeLayout.getWidth() - minWidth;
                        }
                        if (spoidSettinghandleParams.topMargin > SpenColorPickerLayout.this.mParentRelativeLayout.getHeight() - minHeight) {
                            spoidSettinghandleParams.topMargin = SpenColorPickerLayout.this.mParentRelativeLayout.getHeight() - minHeight;
                        }
                        spoidSettingBgParams.leftMargin = spoidSettinghandleParams.leftMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(22.0f);
                        spoidSettingBgParams.topMargin = spoidSettinghandleParams.topMargin + 0;
                        spoidColorImageParams.leftMargin = spoidSettinghandleParams.leftMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(25.0f);
                        spoidColorImageParams.topMargin = spoidSettinghandleParams.topMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(7.0f);
                        spuitCurrentColorParams.leftMargin = spoidSettinghandleParams.leftMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(50.0f);
                        spuitCurrentColorParams.topMargin = spoidSettinghandleParams.topMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(7.0f);
                        spoidExitBtnParams.leftMargin = spoidSettinghandleParams.leftMargin + SpenColorPickerLayout.this.drawableImg.getIntValueAppliedDensity(78.0f);
                        spoidExitBtnParams.topMargin = spoidSettinghandleParams.topMargin;
                        SpenColorPickerLayout.this.mColorPickerHandle.setLayoutParams(spoidSettinghandleParams);
                        SpenColorPickerLayout.this.mSpuitdBG.setLayoutParams(spoidSettingBgParams);
                        SpenColorPickerLayout.this.mColorPickerColorImage.setLayoutParams(spoidColorImageParams);
                        SpenColorPickerLayout.this.mColorPickerCurrentColor.setLayoutParams(spuitCurrentColorParams);
                        SpenColorPickerLayout.this.mColorPickerdExitBtn.setLayoutParams(spoidExitBtnParams);
                        break;
                }
        ...
        this.mSpoidExitListener = new View.OnTouchListener() { // from class: com.samsung.android.sdk.pen.settingui.SpenColorPickerLayout.3
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case 0:
                        SpenColorPickerLayout.this.mColorPickerdExitBtn.setPressed(true);
                        return true;
                    case 1:
                        SpenColorPickerLayout.this.mColorPickerdExitBtn.setPressed(false);
                        SpenColorPickerLayout.this.mColorPickerdExitBtn.performClick();
                        return true;
                    case 2:
                    default:
                        return true;
    ...
    protected void rotatePosition() {
        if (this.mColorPickerHandle != null && this.mIsRotated) {
            ...
            Rect newParentRect = getMovableRect();
            ...
            Rect r = new Rect();
            r.left = this.mOldParentRect.left + spoidSettinghandleParams.leftMargin;
            r.top = this.mOldParentRect.top + spoidSettinghandleParams.topMargin;
            ...
            float left = r.left - this.mOldParentRect.left;
            float right = this.mOldParentRect.right - r.right;
            float top = r.top - this.mOldParentRect.top;
            float bottom = this.mOldParentRect.bottom - r.bottom;
    ...
    private View spuitdBg() {
        ...
        spoidBgButton.setContentDescription(this.mStringUtil.setString("string_gradation"));
    ...
    public void checkPosition() {
        ...
        Rect parentRect = getMovableRect();
        RelativeLayout.LayoutParams spoidSettinghandleParams = (RelativeLayout.LayoutParams) this.mColorPickerHandle.getLayoutParams();
        int lMargin = spoidSettinghandleParams.leftMargin;
        int tMargin = spoidSettinghandleParams.topMargin;
        ...
        if (lMargin != spoidSettinghandleParams.leftMargin || tMargin != spoidSettinghandleParams.topMargin) {
            RelativeLayout.LayoutParams spoidSettingBgParams = (RelativeLayout.LayoutParams) this.mSpuitdBG.getLayoutParams();
            RelativeLayout.LayoutParams spoidColorImageParams = (RelativeLayout.LayoutParams) this.mColorPickerColorImage.getLayoutParams();
            RelativeLayout.LayoutParams spoidExitBtnParams = (RelativeLayout.LayoutParams) this.mColorPickerdExitBtn.getLayoutParams();
            RelativeLayout.LayoutParams spuitCurrentColorParams = (RelativeLayout.LayoutParams) this.mColorPickerCurrentColor.getLayoutParams();
    ...
    private Rect getMovableRect() {
        int[] location = new int[2];
        Rect r = new Rect();
        this.mParentRelativeLayout.getLocationOnScreen(location);
        r.left = location[0];
        r.top = location[1];
        r.right = location[0] + this.mParentRelativeLayout.getWidth();
        r.bottom = location[1] + this.mParentRelativeLayout.getHeight();
        return r;
    }
