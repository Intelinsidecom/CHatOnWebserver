...
public class CreateAccessTokenRep extends JasonParser {
    ...
    private static final String TAG_ACCESS_TOKEN_EXPIRES2 = "expires_in";
    ...
    public CreateAccessTokenRep(String msg) {
        super(msg);
    }
    ...
    public int parseAccessTokenExpires2() {
        return parseInteger(TAG_ACCESS_TOKEN_EXPIRES2);
    }
