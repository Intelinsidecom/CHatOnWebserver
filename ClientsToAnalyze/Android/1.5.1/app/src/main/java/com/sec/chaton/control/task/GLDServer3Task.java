...
public class GLDServer3Task extends AbstractHttpTask2 {
    public GLDServer3Task(Handler handler, HttpEnvelope httpEnvelope) {
    ...
    public void afterRequest(HttpEntry httpEntry) {
        if (httpEntry.m1955d() != null) {
            ...
            ChatONPref.m3522a("expdate", getSSMServerAddress3.expdate);
            ChatONLogWriter.m3508c("MSISDN From Server : " + getSSMServerAddress3.msisdn, getClass().getSimpleName());
            ...
            while (it.hasNext()) {
                ...
                if (server.name.equals("contact")) {
                    ...
                    ChatONLogWriter.m3508c("Primary SMS : " + server.address + " : " + server.port, getClass().getSimpleName());
                    ChatONPref.m3523a("primary_sms_address", server.address);
                    ChatONPref.m3521a("primary_sms_port", server.port);
                }
            }
            ...
            while (it2.hasNext()) {
                ...
                if (server2.name.equals("contact")) {
                    ...
                    ChatONPref.m3523a("secondary_sms_addrss", server2.address);
                    ChatONPref.m3521a("secondary_sms_port", server2.port);
                }
            }
