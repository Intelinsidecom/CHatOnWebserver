...
public class GLDServerTask extends AbstractHttpTask2 {
    public GLDServerTask(Handler handler, HttpEnvelope httpEnvelope) {
    ...
    public void afterRequest(HttpEntry httpEntry) {
        if (httpEntry.m1955d() != null) {
            GetSSMServerAddress getSSMServerAddress = (GetSSMServerAddress) httpEntry.m1955d();
            ChatONPref.m3522a("expdate", getSSMServerAddress.expdate);
