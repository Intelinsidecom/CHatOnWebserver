...
public class InterlockedVideo implements InterlockWithNative {

    /* renamed from: a */
    private Intent f1915a;

    public InterlockedVideo(Intent intent) {
        this.f1915a = intent;
    }
    ...
    public HandleIntent.IntentDest mo2391a() {
        this.f1915a.putExtra("callForward", true);
        this.f1915a.putExtra(DatabaseConstant.TrunkItemColumns.KEY_CONTENT_TYPE, ChatONContract.MessageTable.MsgContentType.VIDEO.m2197a());
        Uri uri = (Uri) this.f1915a.getExtras().get("android.intent.extra.STREAM");
        if (uri.getScheme() != null && uri.getScheme().equals(DatabaseConstant.TrunkCommentColumns.KEY_CONTENT)) {
            ...
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.moveToFirst()) {
                        this.f1915a.putExtra("download_uri", Uri.fromFile(new File(cursorQuery.getString(cursorQuery.getColumnIndex("_data")))).toString());
            ...
            this.f1915a.putExtra("download_uri", uri.toString());
            return HandleIntent.IntentDest.FORWARD;
        }
