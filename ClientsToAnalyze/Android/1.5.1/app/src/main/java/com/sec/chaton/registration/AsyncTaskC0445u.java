...
class AsyncTaskC0445u extends AsyncTask {
    private AsyncTaskC0445u() {
    }

    /* synthetic */ AsyncTaskC0445u(RunnableC0409ag runnableC0409ag) {
        this();
    }
    ...
    public Void doInBackground(Context... contextArr) {
        ...
        String string = ChatONPref.m3519a().getString("msisdn", "");
