...
public interface ChannelBufferIndexFinder {
    ...
    /* renamed from: CR */
    public static final ChannelBufferIndexFinder f4557CR = new ChannelBufferIndexFinder() { // from class: org.jboss.netty.buffer.ChannelBufferIndexFinder.3
        @Override // org.jboss.netty.buffer.ChannelBufferIndexFinder
        public boolean find(ChannelBuffer channelBuffer, int i) {
    ...
    /* renamed from: LF */
    public static final ChannelBufferIndexFinder f4558LF = new ChannelBufferIndexFinder() { // from class: org.jboss.netty.buffer.ChannelBufferIndexFinder.5
        @Override // org.jboss.netty.buffer.ChannelBufferIndexFinder
        public boolean find(ChannelBuffer channelBuffer, int i) {
