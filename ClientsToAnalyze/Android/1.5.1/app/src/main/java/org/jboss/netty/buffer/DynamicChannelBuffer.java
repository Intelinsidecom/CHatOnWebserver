...
public class DynamicChannelBuffer extends AbstractChannelBuffer {
    ...
    public void ensureWritableBytes(int i) {
        ...
        int iCapacity = capacity() == 0 ? 1 : capacity();
    ...
    public ChannelBuffer slice(int i, int i2) {
        return i == 0 ? i2 == 0 ? ChannelBuffers.EMPTY_BUFFER : new TruncatedChannelBuffer(this, i2) : i2 == 0 ? ChannelBuffers.EMPTY_BUFFER : new SlicedChannelBuffer(this, i, i2);
    }
