...
public class StaticChannelPipeline implements ChannelPipeline {
    ...
    final class StaticChannelHandlerContext implements ChannelHandlerContext {
    ...
    public StaticChannelPipeline(ChannelHandler... channelHandlerArr) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            String string = ConversionUtil.toString(i2);
            StaticChannelHandlerContext staticChannelHandlerContext = new StaticChannelHandlerContext(i2, string, channelHandler);
            staticChannelHandlerContextArr[i2] = staticChannelHandlerContext;
            this.name2ctx.put(string, staticChannelHandlerContext);
        }
    ...
    @Override // org.jboss.netty.channel.ChannelPipeline
    public ChannelHandler get(Class cls) {
    ...
    StaticChannelHandlerContext getActualUpstreamContext(int i) {
        for (int i2 = i; i2 < this.contexts.length; i2++) {
            StaticChannelHandlerContext staticChannelHandlerContext = this.contexts[i2];
    ...
    @Override // org.jboss.netty.channel.ChannelPipeline
    public ChannelHandlerContext getContext(Class cls) {
        if (cls == null) {
    ...
    @Override // org.jboss.netty.channel.ChannelPipeline
    public ChannelHandler remove(Class cls) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override // org.jboss.netty.channel.ChannelPipeline
    public ChannelHandler replace(Class cls, String str, ChannelHandler channelHandler) {
        throw new UnsupportedOperationException();
    }
