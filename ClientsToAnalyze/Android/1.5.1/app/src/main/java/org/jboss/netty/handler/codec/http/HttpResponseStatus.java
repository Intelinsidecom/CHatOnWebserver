...
public class HttpResponseStatus implements Comparable {
    ...
    /* renamed from: OK */
    public static final HttpResponseStatus f4578OK = new HttpResponseStatus(200, "OK");
    ...
    public static final HttpResponseStatus BAD_REQUEST = new HttpResponseStatus(AMSLibs.ENUM_VIP_AMS_SAVE_THUMBNAIL_IMAGE_SIZE, "Bad Request");
