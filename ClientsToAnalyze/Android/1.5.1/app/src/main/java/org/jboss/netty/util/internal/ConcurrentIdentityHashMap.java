...
public final class ConcurrentIdentityHashMap extends AbstractMap implements ConcurrentMap {
    ...
    final class EntryIterator extends HashIterator implements ReusableIterator {
        ...
        public Map.Entry next() {
            ...
            return ConcurrentIdentityHashMap.this.new WriteThroughEntry(hashEntryNextEntry.key(), hashEntryNextEntry.value());
        }
    }
    ...
    final class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return ConcurrentIdentityHashMap.this.new EntryIterator();
        }
    ...
    final class KeySet extends AbstractSet {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator iterator() {
            return ConcurrentIdentityHashMap.this.new KeyIterator();
        }
    ...
    final class Segment extends ReentrantLock {
        ...
        int rehash() {
            ...
            if (length >= ConcurrentIdentityHashMap.MAXIMUM_CAPACITY) {
                return 0;
            }
        ...
        */
        java.lang.Object remove(java.lang.Object r12, int r13, java.lang.Object r14, boolean r15) {
            /*
                ...
                int r0 = r0 - r3
                org.jboss.netty.util.internal.ConcurrentIdentityHashMap$HashEntry[] r1 = r11.table     // Catch: java.lang.Throwable -> L64
            ...
            Lf:
                ...
                if (r5 != 0) goto L28
            L25:
                org.jboss.netty.util.internal.ConcurrentIdentityHashMap$HashEntry r4 = r4.next     // Catch: java.lang.Throwable -> L64
                goto Lf
            L28:
                r5 = 0
                if (r4 == 0) goto L69
            ...
            L37:
                ...
                org.jboss.netty.util.internal.ConcurrentIdentityHashMap$HashEntry r5 = r4.next     // Catch: java.lang.Throwable -> L64
                r10 = r3
                r3 = r5
                r5 = r0
                r0 = r10
            L43:
                ...
                int r5 = r5 + (-1)
            L4d:
                org.jboss.netty.util.internal.ConcurrentIdentityHashMap$HashEntry r0 = r0.next     // Catch: java.lang.Throwable -> L64
                goto L43
            L50:
                int r8 = r0.hash     // Catch: java.lang.Throwable -> L64
                java.lang.Object r9 = r0.value()     // Catch: java.lang.Throwable -> L64
                org.jboss.netty.util.internal.ConcurrentIdentityHashMap$HashEntry r3 = r11.newHashEntry(r7, r8, r3, r9)     // Catch: java.lang.Throwable -> L64
                goto L4d
            L5b:
            ...
            L69:
                ...
                goto L60
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jboss.netty.util.internal.ConcurrentIdentityHashMap.Segment.remove(java.lang.Object, int, java.lang.Object, boolean):java.lang.Object");
        }
    ...
    class SimpleEntry implements Map.Entry {
        ...
        /* renamed from: eq */
        private static boolean m4393eq(Object obj, Object obj2) {
        ...
        public boolean equals(Object obj) {
            ...
            Map.Entry entry = (Map.Entry) obj;
            return m4393eq(this.key, entry.getKey()) && m4393eq(this.value, entry.getValue());
        }
    ...
    final class Values extends AbstractCollection {
        ...
        public Iterator iterator() {
            return ConcurrentIdentityHashMap.this.new ValueIterator();
        }
    ...
    public ConcurrentIdentityHashMap(Map map) {
