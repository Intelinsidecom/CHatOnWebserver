...
public final class ConcurrentIdentityWeakKeyHashMap extends AbstractMap implements ConcurrentMap {
    ...
    final class EntryIterator extends HashIterator implements ReusableIterator {
        ...
        public Map.Entry next() {
            ...
            return ConcurrentIdentityWeakKeyHashMap.this.new WriteThroughEntry(hashEntryNextEntry.key(), hashEntryNextEntry.value());
        }
    }
    ...
    final class EntrySet extends AbstractSet {
        ...
        public Iterator iterator() {
            return ConcurrentIdentityWeakKeyHashMap.this.new EntryIterator();
        }
    ...
    final class HashEntry {
        ...
        HashEntry(Object obj, int i, HashEntry hashEntry, Object obj2, ReferenceQueue referenceQueue) {
            this.hash = i;
            this.next = hashEntry;
            this.keyRef = new WeakKeyReference(obj, i, referenceQueue);
            this.valueRef = obj2;
        }
        ...
        final Object dereferenceValue(Object obj) {
            return obj instanceof WeakKeyReference ? ((Reference) obj).get() : obj;
        }
    ...
    final class KeySet extends AbstractSet {
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator iterator() {
            return ConcurrentIdentityWeakKeyHashMap.this.new KeyIterator();
        }
    ...
    final class Segment extends ReentrantLock {
        ...
        HashEntry newHashEntry(Object obj, int i, HashEntry hashEntry, Object obj2) {
            return new HashEntry(obj, i, hashEntry, obj2, this.refQueue);
        }
        ...
        int rehash() {
            ...
            if (length >= ConcurrentIdentityWeakKeyHashMap.MAXIMUM_CAPACITY) {
                return 0;
            }
        ...
        */
        java.lang.Object remove(java.lang.Object r12, int r13, java.lang.Object r14, boolean r15) {
            /*
                ...
                r11.lock()
                if (r15 != 0) goto L9
                r11.removeStale()     // Catch: java.lang.Throwable -> L69
            L9:
                int r0 = r11.count     // Catch: java.lang.Throwable -> L69
                int r0 = r0 - r3
                org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$HashEntry[] r1 = r11.table     // Catch: java.lang.Throwable -> L69
            ...
            L14:
                if (r4 == 0) goto L2d
                java.lang.Object r5 = r4.keyRef     // Catch: java.lang.Throwable -> L69
                if (r12 == r5) goto L2d
                if (r15 != 0) goto L2a
                int r5 = r4.hash     // Catch: java.lang.Throwable -> L69
                if (r13 != r5) goto L2a
                java.lang.Object r5 = r4.key()     // Catch: java.lang.Throwable -> L69
                boolean r5 = r11.keyEq(r12, r5)     // Catch: java.lang.Throwable -> L69
                if (r5 != 0) goto L2d
            L2a:
                org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$HashEntry r4 = r4.next     // Catch: java.lang.Throwable -> L69
                goto L14
            L2d:
                r5 = 0
                if (r4 == 0) goto L6e
                java.lang.Object r6 = r4.value()     // Catch: java.lang.Throwable -> L69
                if (r14 == 0) goto L3c
                boolean r7 = r14.equals(r6)     // Catch: java.lang.Throwable -> L69
                if (r7 == 0) goto L6e
            L3c:
                int r5 = r11.modCount     // Catch: java.lang.Throwable -> L69
                int r5 = r5 + 1
                r11.modCount = r5     // Catch: java.lang.Throwable -> L69
                org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$HashEntry r5 = r4.next     // Catch: java.lang.Throwable -> L69
                r10 = r3
                r3 = r5
                r5 = r0
                r0 = r10
            L48:
                if (r0 == r4) goto L60
                java.lang.Object r7 = r0.key()     // Catch: java.lang.Throwable -> L69
                if (r7 != 0) goto L55
                int r5 = r5 + (-1)
            L52:
                org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$HashEntry r0 = r0.next     // Catch: java.lang.Throwable -> L69
                goto L48
            L55:
                int r8 = r0.hash     // Catch: java.lang.Throwable -> L69
                java.lang.Object r9 = r0.value()     // Catch: java.lang.Throwable -> L69
                org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$HashEntry r3 = r11.newHashEntry(r7, r8, r3, r9)     // Catch: java.lang.Throwable -> L69
                goto L52
            L60:
                r1[r2] = r3     // Catch: java.lang.Throwable -> L69
                r11.count = r5     // Catch: java.lang.Throwable -> L69
                r0 = r6
            L65:
                r11.unlock()
                return r0
            ...
            L6e:
                ...
                goto L65
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap.Segment.remove(java.lang.Object, int, java.lang.Object, boolean):java.lang.Object");
        }
    ...
    class SimpleEntry implements Map.Entry {
        ...
        /* renamed from: eq */
        private static boolean m4394eq(Object obj, Object obj2) {
        ...
        public boolean equals(Object obj) {
            ...
            Map.Entry entry = (Map.Entry) obj;
            return m4394eq(this.key, entry.getKey()) && m4394eq(this.value, entry.getValue());
        }
    ...
    final class Values extends AbstractCollection {
        ...
        public Iterator iterator() {
            return ConcurrentIdentityWeakKeyHashMap.this.new ValueIterator();
        }
    ...
    final class WeakKeyReference extends WeakReference {
        final int hash;

        WeakKeyReference(Object obj, int i, ReferenceQueue referenceQueue) {
    ...
    final class WriteThroughEntry extends SimpleEntry {
        ...
        public Object setValue(Object obj) {
            ...
            ConcurrentIdentityWeakKeyHashMap.this.put(getKey(), obj);
            return value;
        }
    }
    ...
    public ConcurrentIdentityWeakKeyHashMap(Map map) {
