...
final class FragmentManagerImpl extends FragmentManager {
    ...
    */
    void moveToState(final android.support.v4.app.Fragment r9, int r10, int r11, int r12) {
        /*
    ...
    void makeActive(Fragment fragment) {
        if (fragment.mIndex < 0) {
            ...
            fragment.setIndex(((Integer) this.mAvailIndices.remove(this.mAvailIndices.size() - 1)).intValue());
    ...
    public void removeFragment(Fragment fragment, int i, int i2) {
        ...
        if (!fragment.mDetached || z) {
            ...
            moveToState(fragment, z ? 0 : 1, i, i2);
        }
    }
    ...
    public void attachFragment(Fragment fragment, int i, int i2) {
        ...
        if (fragment.mDetached) {
            ...
            if (!fragment.mAdded) {
                ...
                moveToState(fragment, this.mCurState, i, i2);
            }
        }
    }
