...
/* renamed from: com.sec.chaton.push.b.d */
/* loaded from: classes.dex */
class C0871d implements InterfaceC0855c {

    /* renamed from: a */
    final /* synthetic */ C0879l f3001a;

    C0871d(C0879l c0879l) {
        this.f3001a = c0879l;
    }
    ...
    public void mo3449a(boolean z, Throwable th) {
        if (C0921g.f3116a) {
            C0921g.m3637a(C0879l.f3008a, "Prov IChannelListener.onChannelDisconnected()");
        }
        if (Thread.currentThread() == C0893e.m3502a().m3515c()) {
            ...
            new RunnableC0875h(z, th).run();
        } else {
            if (C0921g.f3116a) {
                C0921g.m3637a(C0879l.f3008a, "Thread isn't MessageTaskExecuteThread, post disconnect hander.");
            }
            C0893e.m3502a().m3514b().postAtFrontOfQueue(new RunnableC0875h(z, th));
        }
    }
