...
public class C1311bg {
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x0060 -> B:11:0x0054). Please report as a decompilation issue!!! */
    /* renamed from: a */
    public static boolean m4565a(File file) {
        BitmapFactory.Options options;
        boolean z = true;
        C1341p.m4658b("[ShouldBeResized]: " + file.getName(), GlobalApplication.m3100a().getClass().getName());
        if (file.length() <= 512000) {
            try {
                ...
                C1341p.m4651a("Exception", GlobalApplication.m3100a().getClass().getName());
            }
    ...
    */
    public static java.io.File m4564a(android.content.Context r12, java.io.File r13, java.lang.String r14, android.net.Uri r15) {
        /*
            Method dump skipped, instructions count: 1279
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.chaton.util.C1311bg.m4564a(android.content.Context, java.io.File, java.lang.String, android.net.Uri):java.io.File");
    }
}
