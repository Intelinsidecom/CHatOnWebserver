        ...
        synchronized (this.startStopLock) {
            if (!this.started) {
                try {
                    ...
                    try {
                        DeadLockProofWorker.start(this.executor, new ThreadRenamingRunnable(this, (z ? "New I/O server worker #" : "New I/O client worker #") + this.bossId + '-' + this.f5796id));
            ...
            while (true) {
                ...
                if (messageEvent == null) {
                    ...
                    if (messageEvent == null) {
                        ...
                        sendBufferAcquire = socketSendBufferPool.acquire(messageEvent.getMessage());
