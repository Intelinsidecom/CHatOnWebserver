...
public class CookieEncoder {
    ...
    public String encode() {
        String strEncodeClientSide;
        if (this.server) {
            strEncodeClientSide = encodeServerSide();
        } else {
            strEncodeClientSide = encodeClientSide();
        }
        this.cookies.clear();
        return strEncodeClientSide;
    }
    ...
    private static void add(StringBuilder sb, String str, String str2) {
        ...
        for (int i = 0; i < str2.length(); i++) {
            switch (str2.charAt(i)) {
                ...
                case MREvent.BT_SHARING_RECEIVE_NOT_READY /* 41 */:
                ...
                case MREvent.SNAP_RIGHT /* 60 */:
                case MREvent.PANNING_GYRO /* 61 */:
                case MREvent.ONE_TAPPING_GYRO /* 62 */:
