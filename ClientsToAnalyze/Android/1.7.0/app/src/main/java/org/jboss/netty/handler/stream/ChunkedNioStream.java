...
public class ChunkedNioStream implements ChunkedInput {
    ...
    /* renamed from: in */
    private final ReadableByteChannel f5814in;
    ...
    public ChunkedNioStream(ReadableByteChannel readableByteChannel, int i) {
        ...
        this.f5814in = readableByteChannel;
        this.offset = 0L;
        this.chunkSize = i;
    ...
    public boolean hasNextChunk() {
        ...
        if (this.f5814in.isOpen() && (i = this.f5814in.read(this.byteBuffer)) >= 0) {
    ...
    public Object nextChunk() throws IOException {
        ...
        do {
            int i = this.f5814in.read(this.byteBuffer);
            if (i < 0) {
                break;
            }
            iPosition += i;
