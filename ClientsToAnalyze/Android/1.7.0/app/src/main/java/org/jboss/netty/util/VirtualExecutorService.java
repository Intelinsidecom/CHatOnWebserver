...
public class VirtualExecutorService extends AbstractExecutorService {
    ...
    /* renamed from: e */
    private final Executor f5818e;

    /* renamed from: s */
    private final ExecutorService f5819s;
    ...
    public VirtualExecutorService(Executor executor) {
        ...
        if (executor instanceof ExecutorService) {
            this.f5818e = null;
            this.f5819s = (ExecutorService) executor;
        } else {
    ...
    public void execute(Runnable runnable) {
        ...
        if (this.f5819s != null) {
            this.f5819s.execute(new ChildExecutorRunnable(runnable));
        } else {
            this.f5818e.execute(new ChildExecutorRunnable(runnable));
        }
    }
