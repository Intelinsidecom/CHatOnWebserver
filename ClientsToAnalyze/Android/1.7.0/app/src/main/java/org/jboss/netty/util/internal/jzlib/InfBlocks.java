...
final class InfBlocks {
    ...
    byte[] window;
    int write;
    private static final int[] inflate_mask = {0, 1, 3, 7, 15, 31, 63, 127, MotionEventCompat.ACTION_MASK, 511, 1023, 2047, 4095, 8191, MotionRecognitionManager.EVENT_ALL, 32767, 65535};
    private static final int[] border = {16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15};

    /* renamed from: bb */
    private final int[] f5821bb = new int[1];

    /* renamed from: tb */
    private final int[] f5822tb = new int[1];
