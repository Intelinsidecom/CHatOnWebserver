...
public class FragmentActivity extends Activity {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        ArrayList arrayListRetainNonConfig = this.mFragments.retainNonConfig();
        boolean z2 = false;
    ...
    void invalidateSupportFragmentIndex(int i) {
        ...
        if (this.mAllLoaderManagers != null && (loaderManagerImpl = (LoaderManagerImpl) this.mAllLoaderManagers.get(i)) != null && !loaderManagerImpl.mRetaining) {
            loaderManagerImpl.doDestroy();
    ...
    LoaderManagerImpl getLoaderManager(int i, boolean z, boolean z2) {
        ...
        LoaderManagerImpl loaderManagerImpl = (LoaderManagerImpl) this.mAllLoaderManagers.get(i);
