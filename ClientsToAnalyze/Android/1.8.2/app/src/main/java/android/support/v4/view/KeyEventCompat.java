...
public class KeyEventCompat {
    ...
    class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public boolean metaStateHasModifiers(int i, int i2) {
            return metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(i) & 247, i2, 1, 64, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER), i2, 2, 16, 32) == i2;
        }
    ...
    class HoneycombKeyEventVersionImpl implements KeyEventVersionImpl {
