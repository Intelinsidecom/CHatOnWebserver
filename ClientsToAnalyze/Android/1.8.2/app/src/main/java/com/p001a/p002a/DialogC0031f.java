...
public class DialogC0031f extends Dialog {

    /* renamed from: a */
    static final float[] f16a = {20.0f, 60.0f};

    /* renamed from: b */
    static final float[] f17b = {40.0f, 60.0f};
    ...
    public DialogC0031f(Context context, String str, InterfaceC0029d interfaceC0029d) {
        super(context);
        this.f19d = str;
        this.f20e = interfaceC0029d;
        setOnCancelListener(new DialogInterfaceOnCancelListenerC0032g(this));
    }

    @Override // android.app.Dialog
    protected void onCreate(Bundle bundle) throws Resources.NotFoundException {
        super.onCreate(bundle);
        this.f21f = new ProgressDialogC1806j(getContext());
        this.f21f.requestWindowFeature(1);
        this.f21f.setMessage(getContext().getString(R.string.dialog_connecting_server));
        this.f21f.setOnCancelListener(new DialogInterfaceOnCancelListenerC0033h(this));
        this.f23h = new C0034i(getContext(), this);
    ...
    protected void onStop() {
        super.onStop();
        if (this.f21f != null && this.f21f.isShowing()) {
            this.f21f.dismiss();
        }
    }

    /* renamed from: a */
    private void m24a() throws Resources.NotFoundException {
    ...
    private void m26b() {
        ...
        this.f22g.setVerticalScrollBarEnabled(false);
        this.f22g.setHorizontalScrollBarEnabled(false);
        this.f22g.setWebViewClient(new C0035j(this, null));
