...
class DialogInterfaceOnClickListenerC0359dq implements DialogInterface.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ HandlerC0357do f1503a;

    DialogInterfaceOnClickListenerC0359dq(HandlerC0357do handlerC0357do) {
        this.f1503a = handlerC0357do;
    }
    ...
    public void onClick(DialogInterface dialogInterface, int i) throws RemoteException, OperationApplicationException {
        ...
        arrayList.add(C0555aw.m2754a(this.f1503a.f1501a.f1172h));
        try {
