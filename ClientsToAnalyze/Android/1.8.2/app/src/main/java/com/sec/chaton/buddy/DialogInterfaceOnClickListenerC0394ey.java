...
class DialogInterfaceOnClickListenerC0394ey implements DialogInterface.OnClickListener {

    /* renamed from: a */
    final /* synthetic */ HandlerC0392ew f1553a;

    DialogInterfaceOnClickListenerC0394ey(HandlerC0392ew handlerC0392ew) {
        this.f1553a = handlerC0392ew;
    }
    ...
    public void onClick(DialogInterface dialogInterface, int i) throws RemoteException, OperationApplicationException {
        ...
        arrayList.add(C0555aw.m2754a(this.f1553a.f1551a.f1255m));
        try {
