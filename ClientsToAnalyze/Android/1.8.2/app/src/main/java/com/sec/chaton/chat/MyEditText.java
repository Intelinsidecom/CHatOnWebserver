...
public class MyEditText extends EditText {
    ...
    protected void onSelectionChanged(int i, int i2) {
        int iM2613a = m2613a(i, getText().toString(), true);
        int iM2613a2 = m2613a(i2, getText().toString(), false);
        if (iM2613a != -1 || iM2613a2 != -1) {
            setSelection(iM2613a == -1 ? i : iM2613a, iM2613a2 == -1 ? i2 : iM2613a2);
            if (iM2613a != -1) {
                i = iM2613a;
            }
            if (iM2613a2 != -1) {
    ...
    */
    public boolean onTextContextMenuItem(int r6) {
        /*
            ...
            if (r6 != r0) goto L6a
            java.lang.String r1 = ""
            int r0 = com.sec.chaton.p012c.C0452a.f1722a
            r2 = 11
            if (r0 < r2) goto L4f
        ...
        L33:
            com.sec.chaton.multimedia.emoticon.p r1 = new com.sec.chaton.multimedia.emoticon.p
    ...
    /* renamed from: a */
    private int m2613a(int i, String str, boolean z) {
        int iLastIndexOf = str.substring(0, i).lastIndexOf(91);
        if (iLastIndexOf == -1) {
            return -1;
        }
        for (String str2 : C0970p.f3556a) {
            int iIndexOf = str.indexOf(str2, iLastIndexOf);
