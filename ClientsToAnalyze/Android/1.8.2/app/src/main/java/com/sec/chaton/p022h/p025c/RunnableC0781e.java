...
/* renamed from: com.sec.chaton.h.c.e */
/* loaded from: classes.dex */
public class RunnableC0781e implements Runnable {

    /* renamed from: b */
    private Handler f2864b;

    /* renamed from: d */
    private Handler f2866d;
    ...
    /* renamed from: h */
    private EnumC0695j f2870h;

    /* renamed from: i */
    private EnumC0699n f2871i;
    ...
    /* renamed from: l */
    private ArrayList f2874l = new ArrayList();
    ...
    /* renamed from: q */
    private final Object f2879q = new Object();

    /* renamed from: a */
    DataOutputStream f2863a = null;

    /* renamed from: a */
    public EnumC0695j m3352a() {
        return this.f2870h;
    }

    /* renamed from: b */
    public EnumC0699n m3355b() {
        return this.f2871i;
    }

    /* renamed from: c */
    public String m3356c() {
        return this.f2872j;
    }

    /* renamed from: d */
    public String[] m3357d() {
        return (String[]) this.f2874l.toArray(new String[this.f2874l.size()]);
    }

    /* renamed from: e */
    public String m3358e() {
        return this.f2875m;
    }

    /* renamed from: f */
    public String m3359f() {
        return this.f2873k;
    }

    /* renamed from: g */
    public String m3360g() {
        return this.f2881s;
    }

    /* renamed from: h */
    public String m3361h() {
        return this.f2876n;
    }

    /* renamed from: a */
    public void m3353a(Handler handler) {
        this.f2866d = handler;
    }

    /* renamed from: a */
    public void m3354a(Handler handler, String str, File file, long j, String str2, EnumC0695j enumC0695j, EnumC0699n enumC0699n, String[] strArr, String str3, boolean z, String str4) {
        this.f2864b = handler;
        this.f2875m = str;
        this.f2867e = j;
        this.f2870h = enumC0695j;
        this.f2868f = str2;
        this.f2869g = file;
        this.f2871i = enumC0699n;
        this.f2881s = str4;
        String strSubstring = this.f2869g.getName().substring(this.f2869g.getName().lastIndexOf("."));
        if (strSubstring != null && strSubstring.contains(".")) {
            this.f2872j = strSubstring.substring(1);
        } else {
            this.f2872j = strSubstring;
        }
        this.f2873k = str3;
        for (String str5 : strArr) {
            this.f2874l.add(str5);
        }
        this.f2877o = z;
    }
    ...
    public void run() throws Throwable {
        String strM3628a;
        if (!m3351k()) {
            m3350a(false, 11, null);
            return;
        }
        switch (this.f2871i) {
            case IMAGE:
                strM3628a = MimeTypeMap.getSingleton().getMimeTypeFromExtension(this.f2872j.toLowerCase());
                break;
            case VIDEO:
                strM3628a = MimeTypeMap.getSingleton().getMimeTypeFromExtension(this.f2872j.toLowerCase());
                break;
            case AUDIO:
                strM3628a = "audio/" + this.f2872j.toLowerCase();
                break;
            case CALENDAR:
                strM3628a = "text/x-vcalendar";
                break;
            case CONTACT:
                strM3628a = "text/x-vcard";
                break;
            case GEO:
                strM3628a = "text/x-map";
                break;
            case DOCUMENT:
                strM3628a = FileExplorerActivity.m3628a(this.f2872j.toLowerCase());
                break;
            default:
                strM3628a = "";
                break;
        ...
        int iM3346a = m3346a(strM3628a, sb);
        m3350a(iM3346a == 8, iM3346a, sb.toString());
    }

    /* renamed from: a */
    private boolean m3349a(String str) {
        String upperCase = str.toUpperCase();
        return "JPEG".equals(upperCase) || "JPG".equals(upperCase) || "PNG".equals(upperCase);
    }

    /* renamed from: a */
    private boolean m3348a(File file, String str) {
        if (file == null) {
            return false;
        }
        String upperCase = str.toUpperCase();
    ...
    /* renamed from: k */
    private boolean m3351k() {
        if (this.f2877o) {
            C0665i.m3074c(GlobalApplication.m3260b().getContentResolver(), Long.valueOf(this.f2867e));
        } else {
            if (EnumC0699n.IMAGE == this.f2871i) {
                if (!m3349a(this.f2872j)) {
                    return false;
                }
            } else if (EnumC0699n.VIDEO == this.f2871i && !m3348a(this.f2869g, this.f2872j)) {
                return false;
            }
            String strDecode = Uri.decode(Uri.fromFile(this.f2869g).toString());
            this.f2869g.getName().substring(0, this.f2869g.getName().indexOf("."));
            if (C1767bw.m6002a()) {
                String str = GlobalApplication.m3260b().getExternalFilesDir(null).getAbsolutePath() + "/" + this.f2868f;
                if (!this.f2869g.getAbsolutePath().contains(str)) {
                    strDecode = C1783o.m6032a(this.f2869g.getAbsolutePath(), str, String.valueOf(System.currentTimeMillis()) + this.f2869g.getName().substring(this.f2869g.getName().indexOf(".")));
                }
            }
            String str2 = "\n\n\n\n\n\n";
            if (!TextUtils.isEmpty(this.f2881s)) {
                str2 = "\n\n\n\n\n\n" + this.f2881s;
            }
            C0665i.m3043a(GlobalApplication.m3260b().getContentResolver(), String.valueOf(this.f2867e), this.f2868f, this.f2871i, strDecode, this.f2874l.size(), str2);
            if (strDecode == null) {
                return false;
            }
            this.f2869g = new File(Uri.parse(strDecode).getPath());
            if (this.f2871i == EnumC0699n.CONTACT || this.f2871i == EnumC0699n.CALENDAR || this.f2871i == EnumC0699n.DOCUMENT) {
                C0665i.m3055a(GlobalApplication.m3260b().getContentResolver(), this.f2868f, Long.valueOf(this.f2867e), this.f2873k);
            }
        }
        return true;
    }
    ...
    /* renamed from: a */
    private boolean m3350a(boolean z, int i, String str) throws Throwable {
        if (z) {
            C0665i.m3054a(GlobalApplication.m3260b().getContentResolver(), Long.valueOf(this.f2867e), true);
            Bitmap bitmapM6031a = null;
            if (EnumC0699n.IMAGE == this.f2871i) {
                bitmapM6031a = C1783o.m6031a(GlobalApplication.m3260b(), this.f2869g, true, true);
            } else if (EnumC0699n.VIDEO == this.f2871i) {
                bitmapM6031a = C1783o.m6031a(GlobalApplication.m3260b(), this.f2869g, false, true);
            }
            if (bitmapM6031a != null) {
                bitmapM6031a.recycle();
            }
            this.f2876n = str;
        } else {
            iM3302a = TextUtils.isEmpty(str) ? 0 : C0774a.m3302a(str.substring(str.lastIndexOf(":") + 1).trim());
            if (EnumC0699n.CONTACT == this.f2871i || EnumC0699n.CALENDAR == this.f2871i || EnumC0699n.DOCUMENT == this.f2871i) {
                C0665i.m3052a(GlobalApplication.m3260b().getContentResolver(), Long.valueOf(this.f2867e), this.f2873k);
            } else {
                C0665i.m3049a(GlobalApplication.m3260b().getContentResolver(), Long.valueOf(this.f2867e));
            }
            this.f2876n = "";
        }
        if (this.f2864b != null) {
            Message messageObtainMessage = this.f2864b.obtainMessage(1);
            messageObtainMessage.arg1 = i;
            messageObtainMessage.arg2 = iM3302a;
            messageObtainMessage.obj = new C0783g(this, z, this.f2867e);
            this.f2864b.sendMessage(messageObtainMessage);
        }
        return true;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:110:0x03da, code lost:
        ...
        m3347a(100);
        com.sec.chaton.util.C1786r.m6061b("[End uploading] Uploaded FileSize: " + r6 + ", FileName:" + r12 + "." + r13 + ", Time(Upload): " + (java.lang.System.currentTimeMillis() - r15), getClass().getSimpleName());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:111:0x042b, code lost:
        ...
        r6 = com.sec.chaton.p022h.C0776c.m3309a(r5).trim();
        com.sec.chaton.util.C1786r.m6061b("[Upload IP] " + r6, getClass().getSimpleName());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:142:0x04ee, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L143;
     */
    /* JADX WARN: Code restructure failed: missing block: B:143:0x04f0, code lost:
    
        com.sec.chaton.util.C1786r.m6056a(r6, getClass().getName());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:146:0x04ff, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L147;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:150:0x0510, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L151;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:154:0x0521, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L155;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:158:0x0532, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L159;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:162:0x0544, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L163;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:166:0x0556, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L167;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:170:0x0568, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L171;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:174:0x057a, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L175;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:178:0x058c, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L179;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:182:0x059e, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L183;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:186:0x05b0, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L187;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:206:0x060a, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L207;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:210:0x061c, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L211;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:214:0x062e, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L215;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:218:0x0640, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L219;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:222:0x0652, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L223;
     */
    /* JADX WARN: Code restructure failed: missing block: B:223:0x0654, code lost:
    
        com.sec.chaton.util.C1786r.m6056a(r5, getClass().getName());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:226:0x0664, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L227;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:230:0x0676, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L231;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:234:0x0688, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L235;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x02cb, code lost:
        ...
        r7 = com.sec.chaton.p022h.p024b.C0775b.m3303a(com.sec.chaton.p022h.C0776c.m3309a(r6));
        com.sec.chaton.util.C1786r.m6054a("[Upload]" + r5 + ":" + r7, getClass().getSimpleName());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x0336, code lost:
        ...
        com.sec.chaton.util.C1789u.m6075a().edit().putBoolean("is_file_server_primary ", false).commit();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x039e, code lost:
        ...
        if (com.sec.chaton.util.C1786r.f6452b != false) goto L94;
     */
    ...
    */
    private int m3346a(java.lang.String r24, java.lang.StringBuilder r25) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 1759
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.chaton.p022h.p025c.RunnableC0781e.m3346a(java.lang.String, java.lang.StringBuilder):int");
    }

    /* renamed from: a */
    private boolean m3347a(int i) {
        if (this.f2866d == null) {
            return false;
        }
        synchronized (this.f2879q) {
        ...
        Message messageObtainMessage = this.f2866d.obtainMessage(2);
        messageObtainMessage.arg1 = i;
        return this.f2866d.sendMessage(messageObtainMessage);
    }

    /* renamed from: j */
    public boolean m3363j() {
