...
class C1074d implements InterfaceC1088a {

    /* renamed from: a */
    final /* synthetic */ C1072b f3996a;

    C1074d(C1072b c1072b) {
        this.f3996a = c1072b;
    }
    ...
    public void mo4132a(boolean z, Throwable th) {
        if (C1139g.f4142a) {
            C1139g.m4308a(C1072b.f3984a, "Push IChannelListener.onChannelDisconnected()");
        }
        if (Thread.currentThread() == C1111e.m4174a().m4187c()) {
            ...
            new RunnableC1080j(z, th).run();
        } else {
            if (C1139g.f4142a) {
                C1139g.m4308a(C1072b.f3984a, "Thread isn't MessageTaskExecuteThread, post disconnect hander.");
            }
            C1111e.m4174a().m4186b().postAtFrontOfQueue(new RunnableC1080j(z, th));
        }
    }
