...
class HandlerC1196i extends Handler {

    /* renamed from: a */
    final /* synthetic */ ActivityNonSelfSMS.NonSelfSMSFragment f4411a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HandlerC1196i(ActivityNonSelfSMS.NonSelfSMSFragment nonSelfSMSFragment, Looper looper) {
        super(looper);
        this.f4411a = nonSelfSMSFragment;
    }
    ...
    public void handleMessage(Message message) {
        ...
        if (c0101b.m664a() && c0101b.m665b() != EnumC0803m.ERROR && (getVersionNotice = (GetVersionNotice) c0101b.m671d()) != null) {
            if (getVersionNotice.uptodate.booleanValue()) {
                this.f4411a.m4360j();
            } else if (getVersionNotice.critical.booleanValue()) {
                this.f4411a.m4336a(getVersionNotice);
            }
        }
    }
}
