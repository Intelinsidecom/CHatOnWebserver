...
public class ChoicePanel extends HorizontalScrollView {
    ...
    /* renamed from: a */
    public void m7439a(String str, String str2) {
        if (str != null && str2 != null) {
            ...
            if (linearLayout.findViewWithTag(str) == null) {
                ...
                button.setText(str2);
                button.setTag(str);
                button.setOnClickListener(this.f7696a);
                linearLayout.addView(button);
                if (getVisibility() == 8) {
                    setVisibility(0);
                }
                post(new RunnableC2132d(this));
            }
        }
    }

    /* renamed from: a */
    public void m7438a(String str) {
        LinearLayout linearLayout = (LinearLayout) getChildAt(0);
    ...
    class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new C2133e();
        ArrayList idList;
        ArrayList textList;

        /* synthetic */ SavedState(Parcel parcel, RunnableC2132d runnableC2132d) {
            this(parcel);
        }
        ...
        if (savedState.idList != null && savedState.textList != null) {
            ...
            while (true) {
                ...
                if (i2 < savedState.idList.size()) {
                    m7439a((String) savedState.idList.get(i2), (String) savedState.textList.get(i2));
                    i = i2 + 1;
                } else {
                    return;
                }
