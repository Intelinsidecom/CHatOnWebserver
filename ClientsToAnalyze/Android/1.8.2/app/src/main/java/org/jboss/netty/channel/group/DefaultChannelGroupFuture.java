    ...
    */
    private boolean await0(long r13, boolean r15) throws java.lang.InterruptedException {
        ...
        L48:
            ...
            r2 = r3
        L56:
            boolean r3 = r12.done     // Catch: java.lang.Throwable -> L9b
            if (r3 == 0) goto L7e
            r0 = 1
        ...
        L7c:
            ...
            goto L56
        L7e:
            long r3 = java.lang.System.nanoTime()     // Catch: java.lang.Throwable -> L9b
            long r3 = r3 - r0
            long r3 = r13 - r3
            r5 = 0
            int r5 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r5 > 0) goto L9e
            boolean r0 = r12.done     // Catch: java.lang.Throwable -> L9b
            int r1 = r12.waiters     // Catch: java.lang.Throwable -> L2f
            int r1 = r1 + (-1)
            r12.waiters = r1     // Catch: java.lang.Throwable -> L2f
            monitor-exit(r12)     // Catch: java.lang.Throwable -> L2f
