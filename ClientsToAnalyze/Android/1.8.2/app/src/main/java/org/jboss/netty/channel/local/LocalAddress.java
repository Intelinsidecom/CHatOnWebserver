...
public final class LocalAddress extends SocketAddress implements Comparable {
    ...
    public int hashCode() {
        return this.ephemeral ? System.identityHashCode(this) : this.f7852id.hashCode();
    }
    ...
    public int compareTo(LocalAddress localAddress) {
        if (this.ephemeral) {
            ...
            int iIdentityHashCode2 = System.identityHashCode(localAddress);
