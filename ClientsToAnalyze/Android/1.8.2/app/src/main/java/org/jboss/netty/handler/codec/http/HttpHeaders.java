...
public class HttpHeaders {
    ...
    public final class Names {
        ...
        /* renamed from: TE */
        public static final String f7866TE = "TE";
    ...
    /* renamed from: eq */
    private static boolean m7537eq(String str, String str2) {
    ...
    private void removeHeader0(int i, int i2, String str) {
        Entry entry = this.entries[i2];
        if (entry != null) {
            while (entry.hash == i && m7537eq(str, entry.key)) {
                entry.remove();
                entry = entry.next;
                if (entry != null) {
            ...
            while (true) {
                ...
                if (entry2 != null) {
                    if (entry2.hash == i && m7537eq(str, entry2.key)) {
    ...
    String getHeader(String str) {
        ...
        for (Entry entry = this.entries[index(iHash)]; entry != null; entry = entry.next) {
            if (entry.hash == iHash && m7537eq(str, entry.key)) {
                return entry.value;
            }
        }
        return null;
