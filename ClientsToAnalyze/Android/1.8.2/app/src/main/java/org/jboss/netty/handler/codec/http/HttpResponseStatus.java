...
public class HttpResponseStatus implements Comparable {
    ...
    public static final HttpResponseStatus SWITCHING_PROTOCOLS = new HttpResponseStatus(MediaEntity.Size.CROP, "Switching Protocols");
    public static final HttpResponseStatus PROCESSING = new HttpResponseStatus(102, "Processing");

    /* renamed from: OK */
    public static final HttpResponseStatus f7868OK = new HttpResponseStatus(HttpResponseCode.f7897OK, "OK");
    ...
    public static final HttpResponseStatus MULTIPLE_CHOICES = new HttpResponseStatus(HttpResponseCode.MULTIPLE_CHOICES, "Multiple Choices");
    public static final HttpResponseStatus MOVED_PERMANENTLY = new HttpResponseStatus(301, "Moved Permanently");
    public static final HttpResponseStatus FOUND = new HttpResponseStatus(HttpResponseCode.FOUND, "Found");
    public static final HttpResponseStatus SEE_OTHER = new HttpResponseStatus(303, "See Other");
    public static final HttpResponseStatus NOT_MODIFIED = new HttpResponseStatus(HttpResponseCode.NOT_MODIFIED, "Not Modified");
    ...
    public static final HttpResponseStatus UNAUTHORIZED = new HttpResponseStatus(HttpResponseCode.UNAUTHORIZED, "Unauthorized");
    public static final HttpResponseStatus PAYMENT_REQUIRED = new HttpResponseStatus(402, "Payment Required");
    public static final HttpResponseStatus FORBIDDEN = new HttpResponseStatus(HttpResponseCode.FORBIDDEN, "Forbidden");
    public static final HttpResponseStatus NOT_FOUND = new HttpResponseStatus(HttpResponseCode.NOT_FOUND, "Not Found");
    public static final HttpResponseStatus METHOD_NOT_ALLOWED = new HttpResponseStatus(405, "Method Not Allowed");
    public static final HttpResponseStatus NOT_ACCEPTABLE = new HttpResponseStatus(HttpResponseCode.NOT_ACCEPTABLE, "Not Acceptable");
    ...
    public static final HttpResponseStatus REQUEST_ENTITY_TOO_LARGE = new HttpResponseStatus(HttpResponseCode.TOO_LONG, "Request Entity Too Large");
    ...
    public static final HttpResponseStatus INTERNAL_SERVER_ERROR = new HttpResponseStatus(HttpResponseCode.INTERNAL_SERVER_ERROR, "Internal Server Error");
    public static final HttpResponseStatus NOT_IMPLEMENTED = new HttpResponseStatus(501, "Not Implemented");
    public static final HttpResponseStatus BAD_GATEWAY = new HttpResponseStatus(HttpResponseCode.BAD_GATEWAY, "Bad Gateway");
    public static final HttpResponseStatus SERVICE_UNAVAILABLE = new HttpResponseStatus(HttpResponseCode.SERVICE_UNAVAILABLE, "Service Unavailable");
