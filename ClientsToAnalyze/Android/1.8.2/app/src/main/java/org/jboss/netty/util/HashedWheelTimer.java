...
public class HashedWheelTimer implements Timer {
    ...
    /* renamed from: id */
    private static final AtomicInteger f7877id = new AtomicInteger();
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long j, TimeUnit timeUnit, int i) {
        ...
        this.workerThread = threadFactory.newThread(new ThreadRenamingRunnable(this.worker, "Hashed wheel timer #" + f7877id.incrementAndGet()));
