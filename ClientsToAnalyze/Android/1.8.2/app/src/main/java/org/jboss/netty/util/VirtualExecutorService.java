...
public class VirtualExecutorService extends AbstractExecutorService {
    ...
    /* renamed from: e */
    private final Executor f7879e;

    /* renamed from: s */
    private final ExecutorService f7880s;
    ...
    public VirtualExecutorService(Executor executor) {
        ...
        if (executor instanceof ExecutorService) {
            this.f7879e = null;
            this.f7880s = (ExecutorService) executor;
        } else {
            this.f7879e = executor;
            this.f7880s = null;
        }
    }
    ...
    public void execute(Runnable runnable) {
        ...
        if (this.f7880s != null) {
            this.f7880s.execute(new ChildExecutorRunnable(runnable));
        } else {
            this.f7879e.execute(new ChildExecutorRunnable(runnable));
        }
    }
