...
public final class ConcurrentIdentityHashMap extends AbstractMap implements ConcurrentMap {
    ...
    */
    public int size() {
        /*
            r15 = this;
            org.jboss.netty.util.internal.ConcurrentIdentityHashMap$Segment[] r7 = r15.segments
            r3 = 0
            r1 = 0
            int r0 = r7.length
            int[] r8 = new int[r0]
        ...
        L8b:
            ...
            goto L4a
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jboss.netty.util.internal.ConcurrentIdentityHashMap.size():int");
    }
    ...
    class SimpleEntry implements Map.Entry {
        ...
        public boolean equals(Object obj) {
            ...
            return m7539eq(this.key, entry.getKey()) && m7539eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m7539eq(Object obj, Object obj2) {
