...
public final class ConcurrentIdentityWeakKeyHashMap extends AbstractMap implements ConcurrentMap {
    ...
    final class Segment extends ReentrantLock {
        ...
        boolean containsValue(Object obj) {
            Object objDereferenceValue;
            if (this.count != 0) {
                for (HashEntry hashEntry : this.table) {
                    for (; hashEntry != null; hashEntry = hashEntry.next) {
                        Object obj2 = hashEntry.valueRef;
                        if (obj2 == null) {
                            objDereferenceValue = readValueUnderLock(hashEntry);
                        } else {
                            objDereferenceValue = hashEntry.dereferenceValue(obj2);
                        }
                        if (obj.equals(objDereferenceValue)) {
                            return true;
                        }
                    }
                }
    ...
    */
    public int size() {
        /*
            r15 = this;
            org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$Segment[] r7 = r15.segments
            r3 = 0
            r1 = 0
            int r0 = r7.length
            int[] r8 = new int[r0]
        ...
        L8b:
            ...
            goto L4a
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap.size():int");
    }
    ...
    class SimpleEntry implements Map.Entry {
        ...
        public boolean equals(Object obj) {
            ...
            return m7540eq(this.key, entry.getKey()) && m7540eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m7540eq(Object obj, Object obj2) {
