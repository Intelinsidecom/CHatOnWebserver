...
public class LinkedTransferQueue extends AbstractQueue implements Serializable, BlockingQueue {
    ...
    /* renamed from: MP */
    private static final boolean f7881MP;
    ...
    static {
        f7881MP = Runtime.getRuntime().availableProcessors() > 1;
    ...
    final class Node {
        ...
        private static final AtomicReferenceFieldUpdater itemUpdater = AtomicFieldUpdaterUtil.newRefUpdater(Node.class, Object.class, "item");
    ...
    */
    private java.lang.Object xfer(java.lang.Object r9, boolean r10, int r11, long r12) {
        /*
            r8 = this;
            r3 = 0
            r4 = 1
  ...
  0x0080: PHI (r1v3 int) = (r1v2 int), (r1v6 int) binds: [B:25:0x0055, B:20:0x0042] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private java.lang.Object awaitMatch(org.jboss.netty.util.internal.LinkedTransferQueue.Node r13, org.jboss.netty.util.internal.LinkedTransferQueue.Node r14, java.lang.Object r15, boolean r16, long r17) {
        /*
            r12 = this;
            if (r16 == 0) goto L1f
