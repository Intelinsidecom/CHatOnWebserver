...
final class Deflate {
    ...
    static {
        ...
        config_table[6] = new Config(8, 16, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER, 2);
        config_table[7] = new Config(8, 32, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER, 256, 2);
        config_table[8] = new Config(32, AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER, MAX_MATCH, AccessibilityEventCompat.TYPE_TOUCH_EXPLORATION_GESTURE_END, 2);
