...
public final class TwitterFactory implements Serializable {
    ...
    static {
        ...
        try {
            ...
            try {
                SINGLETON = (Twitter) TWITTER_CONSTRUCTOR.newInstance(ConfigurationContext.getInstance(), DEFAULT_AUTHORIZATION);
    ...
    public Twitter getInstance(Authorization authorization) {
        try {
            return (Twitter) TWITTER_CONSTRUCTOR.newInstance(this.conf, authorization);
