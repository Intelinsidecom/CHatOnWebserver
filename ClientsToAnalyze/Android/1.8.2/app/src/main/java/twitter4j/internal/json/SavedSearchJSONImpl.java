...
final class SavedSearchJSONImpl extends TwitterResponseImpl implements SavedSearch {
    ...
    static ResponseList createSavedSearchList(HttpResponse httpResponse, Configuration configuration) throws IllegalAccessException, JSONException, TwitterException, IOException, IllegalArgumentException, InvocationTargetException {
        if (configuration.isJSONStoreEnabled()) {
            DataObjectFactoryUtil.clearThreadLocalMap();
        }
    ...
    private void init(JSONObject jSONObject) {
        ...
        this.f7902id = z_T4JInternalParseUtil.getInt("id", jSONObject);
    }

    public int compareTo(SavedSearch savedSearch) {
        return this.f7902id - savedSearch.getId();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SavedSearch) && this.f7902id == ((SavedSearch) obj).getId();
    }

    public int hashCode() {
        return (((((((this.createdAt.hashCode() * 31) + this.query.hashCode()) * 31) + this.position) * 31) + this.name.hashCode()) * 31) + this.f7902id;
    }

    public String toString() {
        return new StringBuffer().append("SavedSearchJSONImpl{createdAt=").append(this.createdAt).append(", query='").append(this.query).append('\'').append(", position=").append(this.position).append(", name='").append(this.name).append('\'').append(", id=").append(this.f7902id).append('}').toString();
    }
}
