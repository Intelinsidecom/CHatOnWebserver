...
class UserListJSONImpl extends TwitterResponseImpl implements Serializable, UserList {
    ...
    private void init(JSONObject jSONObject) throws TwitterException {
        this.f7906id = z_T4JInternalParseUtil.getInt("id", jSONObject);
    ...
    public int compareTo(UserList userList) {
        return this.f7906id - userList.getId();
    }
    ...
    static PagableResponseList createPagableUserListList(HttpResponse httpResponse, Configuration configuration) throws IllegalAccessException, JSONException, TwitterException, IOException, IllegalArgumentException, InvocationTargetException {
        try {
            if (configuration.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
    ...
    static ResponseList createUserListList(HttpResponse httpResponse, Configuration configuration) throws IllegalAccessException, JSONException, TwitterException, IOException, IllegalArgumentException, InvocationTargetException {
        try {
            if (configuration.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
