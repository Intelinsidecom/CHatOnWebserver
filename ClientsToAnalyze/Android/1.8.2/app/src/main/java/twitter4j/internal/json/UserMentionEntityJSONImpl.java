...
class UserMentionEntityJSONImpl implements UserMentionEntity {
    ...
    private void init(JSONObject jSONObject) throws JSONException, TwitterException {
        try {
            ...
            this.f7907id = z_T4JInternalParseUtil.getLong("id", jSONObject);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.end == userMentionEntityJSONImpl.end && this.f7907id == userMentionEntityJSONImpl.f7907id && this.start == userMentionEntityJSONImpl.start) {
    ...
    public int hashCode() {
        return (((((this.name != null ? this.name.hashCode() : 0) + (((this.start * 31) + this.end) * 31)) * 31) + (this.screenName != null ? this.screenName.hashCode() : 0)) * 31) + ((int) (this.f7907id ^ (this.f7907id >>> 32)));
    }

    public String toString() {
        return new StringBuffer().append("UserMentionEntityJSONImpl{start=").append(this.start).append(", end=").append(this.end).append(", name='").append(this.name).append('\'').append(", screenName='").append(this.screenName).append('\'').append(", id=").append(this.f7907id).append('}').toString();
    }
}
