...
public final class z_T4JInternalParseUtil {
    private static ThreadLocal formatMap = new ThreadLocal() { // from class: twitter4j.internal.util.z_T4JInternalParseUtil.1
    ...
    public static Date getDate(String str, String str2) throws TwitterException {
        SimpleDateFormat simpleDateFormat = (SimpleDateFormat) ((Map) formatMap.get()).get(str2);
        if (simpleDateFormat == null) {
            SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat(str2, Locale.ENGLISH);
            simpleDateFormat2.setTimeZone(TimeZone.getTimeZone("GMT"));
            ((Map) formatMap.get()).put(str2, simpleDateFormat2);
    ...
    public static int toAccessLevel(HttpResponse httpResponse) {
        ...
        switch (responseHeader.length()) {
            ...
            case 10:
                return 2;
            case C0229at.HorizontalSrollView_android_nextFocusLeft /* 25 */:
                return 3;
