...
public final class DataObjectFactory {
    ...
    static {
        ...
        try {
            ...
            rawJsonMap = new ThreadLocal() { // from class: twitter4j.json.DataObjectFactory.1
    ...
    public static Status createStatus(String str) throws TwitterException {
        try {
            return (Status) statusConstructor.newInstance(new JSONObject(str));
    ...
    public static User createUser(String str) throws TwitterException {
        try {
            return (User) userConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static AccountTotals createAccountTotals(String str) throws TwitterException {
        try {
            return (AccountTotals) accountTotalsConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Tweet createTweet(String str) throws TwitterException {
        try {
            return (Tweet) tweetConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Relationship createRelationship(String str) throws TwitterException {
        try {
            return (Relationship) relationshipConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Place createPlace(String str) throws TwitterException {
        try {
            return (Place) placeConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static SavedSearch createSavedSearch(String str) throws TwitterException {
        try {
            return (SavedSearch) savedSearchConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Trend createTrend(String str) throws TwitterException {
        try {
            return (Trend) trendConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Trends createTrends(String str) throws TwitterException {
        try {
            return (Trends) trendsConstructor.newInstance(str);
        } catch (IllegalAccessException e) {
    ...
    public static IDs createIDs(String str) throws TwitterException {
        try {
            return (IDs) IDsConstructor.newInstance(str);
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static RateLimitStatus createRateLimitStatus(String str) throws TwitterException {
        try {
            return (RateLimitStatus) rateLimitStatusConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Category createCategory(String str) throws TwitterException {
        try {
            return (Category) categoryConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static DirectMessage createDirectMessage(String str) throws TwitterException {
        try {
            return (DirectMessage) directMessageConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static Location createLocation(String str) throws TwitterException {
        try {
            return (Location) locationConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static UserList createUserList(String str) throws TwitterException {
        try {
            return (UserList) userListConstructor.newInstance(new JSONObject(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    public static RelatedResults createRelatedResults(String str) throws TwitterException {
        try {
            return (RelatedResults) relatedResultsConstructor.newInstance(new JSONArray(str));
        } catch (IllegalAccessException e) {
            throw new AssertionError(e);
        } catch (InstantiationException e2) {
            throw new TwitterException(e2);
    ...
    static Object registerJSONObject(Object obj, Object obj2) {
        ((Map) rawJsonMap.get()).put(obj, obj2);
        return obj;
    }
}
