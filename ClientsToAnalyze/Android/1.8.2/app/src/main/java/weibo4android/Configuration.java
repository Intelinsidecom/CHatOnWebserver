...
public class Configuration {
    ...
    static void init() throws ClassNotFoundException {
        ...
        defaultProperty.setProperty("weibo4j.http.connectionTimeout", "30000");
    ...
    public static String getProperty(String str, String str2) {
        ...
        try {
            ...
            str2 = (property2 != null || (property = defaultProperty.getProperty(new StringBuilder(String.valueOf(str)).append(".fallback").toString())) == null) ? property2 : System.getProperty(property);
    ...
    */
    private static java.lang.String replace(java.lang.String r5) {
        ...
        L4:
            ...
            r3.<init>(r1)
            java.lang.String r1 = getProperty(r2)
