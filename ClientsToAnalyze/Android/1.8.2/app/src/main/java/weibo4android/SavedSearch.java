...
public class SavedSearch extends WeiboResponse {
    ...
    static List constructSavedSearches(Response response) throws WeiboException {
    ...
    private void init(JSONObject jSONObject) throws WeiboException {
        try {
            ...
            this.f7914id = getInt("id", jSONObject);
        } catch (JSONException e) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f7914id == savedSearch.f7914id && this.position == savedSearch.position && this.createdAt.equals(savedSearch.createdAt) && this.name.equals(savedSearch.name) && this.query.equals(savedSearch.query);
    }

    public int hashCode() {
        return (((((((this.createdAt.hashCode() * 31) + this.query.hashCode()) * 31) + this.position) * 31) + this.name.hashCode()) * 31) + this.f7914id;
    }

    public String toString() {
        return "SavedSearch{createdAt=" + this.createdAt + ", query='" + this.query + "', position=" + this.position + ", name='" + this.name + "', id=" + this.f7914id + '}';
    }
}
