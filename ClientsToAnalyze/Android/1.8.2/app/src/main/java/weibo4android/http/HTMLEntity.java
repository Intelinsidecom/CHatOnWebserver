...
public class HTMLEntity {
    ...
    public static void escape(StringBuffer stringBuffer) {
        ...
        while (true) {
            ...
            if (i < stringBuffer.length()) {
                String str = (String) entityEscapeMap.get(stringBuffer.substring(i, i + 1));
                if (str != null) {
    ...
    public static void unescape(StringBuffer stringBuffer) {
        ...
        int iIndexOf2;
        int i = 0;
        while (i < stringBuffer.length() && -1 != (iIndexOf = stringBuffer.indexOf("&", i)) && -1 != (iIndexOf2 = stringBuffer.indexOf(";", iIndexOf)) && 10 > iIndexOf2 - iIndexOf) {
            String str = (String) escapeEntityMap.get(stringBuffer.substring(iIndexOf, iIndexOf2 + 1));
            if (str != null) {
