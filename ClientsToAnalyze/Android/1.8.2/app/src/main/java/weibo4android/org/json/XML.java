...
public class XML {
    ...
    /* renamed from: EQ */
    public static final Character f7922EQ = new Character('=');

    /* renamed from: GT */
    public static final Character f7923GT = new Character('>');

    /* renamed from: LT */
    public static final Character f7924LT = new Character('<');
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (cCharAt) {
                case C0229at.HorizontalSrollView_android_minWidth /* 34 */:
                    stringBuffer.append("&quot;");
                    break;
                case C0229at.HorizontalSrollView_android_isScrollContainer /* 38 */:
                    stringBuffer.append("&amp;");
                    break;
                case '<':
                    stringBuffer.append("&lt;");
    ...
    private static boolean parse(XMLTokener xMLTokener, JSONObject jSONObject, String str) throws JSONException {
        ...
        if (objNextToken == BANG) {
            ...
            do {
                ...
                if (objNextMeta == f7924LT) {
                    i++;
                } else if (objNextMeta == f7923GT) {
                    i--;
                }
            } while (i > 0);
            return false;
        ...
        if (objNextToken == SLASH) {
            ...
            if (xMLTokener.nextToken() != f7923GT) {
        ...
        while (true) {
            ...
            if (objNextToken3 instanceof String) {
                ...
                while (true) {
                    ...
                    } else if (objNextContent == f7924LT && parse(xMLTokener, jSONObject2, str2)) {
