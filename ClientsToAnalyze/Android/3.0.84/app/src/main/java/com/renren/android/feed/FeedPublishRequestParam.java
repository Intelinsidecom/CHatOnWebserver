...
public class FeedPublishRequestParam extends AbstractC0196a implements Parcelable {
    ...
    public static final Parcelable.Creator<FeedPublishRequestParam> CREATOR = new C0213a();
    ...
    /* renamed from: a */
    public Bundle m563a() throws C0212f {
        if (this.name == null || this.name.length() == 0 || this.description == null || this.description.length() == 0 || this.url == null || this.url.length() == 0) {
            throw new C0212f(-1, "Required parameter could not be null.", "Required parameter could not be null.");
        }
        if (m562b() != 0) {
            throw new C0212f(-3, "Some parameter is illegal for feed.", "Some parameter is illegal for feed.");
        }
        Bundle bundle = new Bundle();
