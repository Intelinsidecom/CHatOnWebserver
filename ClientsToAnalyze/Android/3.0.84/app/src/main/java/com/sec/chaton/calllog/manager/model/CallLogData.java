...
public class CallLogData implements Parcelable {
    ...
    public static final Parcelable.Creator CREATOR = new C0843b();
    public int _id = -1;
    public int callmethod = -1;
    public int myCalllogtype = -1;
    public int myDuration = -1;
    public List<C0844c> userInfo = null;
    ...
    /* renamed from: a */
    private void m4467a(Cursor cursor) {
        if ((cursor == null || (cursor.getPosition() < cursor.getCount() && cursor.getPosition() >= 0)) && cursor != null) {
            ...
            if (string != null && !string.isEmpty()) {
                ...
                this.userInfo.add(new C0844c(this, string, string2, string3, string4, string5, i, i2, string6, string7, string8, i3, i4));
            }
    ...
    /* renamed from: a */
    public ContentValues m4470a(int i) {
    ...
    /* renamed from: a */
    public int m4469a(Cursor cursor, int i) {
        CallLogData callLogData = new CallLogData(cursor);
        if (callLogData.userInfo == null || callLogData.userInfo.isEmpty() || callLogData.userInfo.get(0).f3205a == null || callLogData.userInfo.get(0).f3205a.isEmpty()) {
            return 5;
        }
        ...
        if (callLogData.groupcallkey == null && this.groupcallkey == null) {
            if (i != 2 && callLogData.userInfo.get(0).f3205a.equals(this.userInfo.get(0).f3205a) && (callLogData.userInfo.get(0).f3216l == this.userInfo.get(0).f3216l || ((callLogData.userInfo.get(0).f3216l == 0 && this.userInfo.get(0).f3216l == 1) || (callLogData.userInfo.get(0).f3216l == 1 && this.userInfo.get(0).f3216l == 0)))) {
                if (!C0841a.m4451a().m4463c(callLogData.userInfo.get(0).f3214j, this.userInfo.get(0).f3214j)) {
                    return 6;
                }
                if (i == 1) {
                    ArrayList arrayList = new ArrayList();
            ...
            if (this.groupcallkey.get(this.groupcallkey.size() - 1).intValue() == callLogData.groupcallkey.get(0).intValue()) {
                ...
                this.userInfo.add(new C0844c(this, callLogData.userInfo.get(0).f3205a, callLogData.userInfo.get(0).f3206b, callLogData.userInfo.get(0).f3207c, callLogData.userInfo.get(0).f3208d, callLogData.userInfo.get(0).f3209e, callLogData.userInfo.get(0).f3210f, callLogData.userInfo.get(0).f3211g, callLogData.userInfo.get(0).f3212h, callLogData.userInfo.get(0).f3213i, callLogData.userInfo.get(0).f3214j, callLogData.userInfo.get(0).f3215k, callLogData.userInfo.get(0).f3216l));
    ...
    /* renamed from: a */
    public boolean m4472a(CallLogData callLogData) {
        return false;
    }

    /* renamed from: a */
    public ArrayList<Integer> m4471a() {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if (this.userInfo == null || this.userInfo.isEmpty()) {
            ...
            for (C0844c c0844c : this.userInfo) {
                if (c0844c.f3205a == null || c0844c.f3205a.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3205a.length());
                    parcel.writeString(c0844c.f3205a);
                }
                if (c0844c.f3206b == null || c0844c.f3206b.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3206b.length());
                    parcel.writeString(c0844c.f3206b);
                }
                if (c0844c.f3207c == null || c0844c.f3207c.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3207c.length());
                    parcel.writeString(c0844c.f3207c);
                }
                if (c0844c.f3208d == null || c0844c.f3208d.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3208d.length());
                    parcel.writeString(c0844c.f3208d);
                }
                if (c0844c.f3209e == null || c0844c.f3209e.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3209e.length());
                    parcel.writeString(c0844c.f3209e);
                }
                parcel.writeInt(c0844c.f3210f);
                parcel.writeInt(c0844c.f3211g);
                if (c0844c.f3212h == null || c0844c.f3212h.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3212h.length());
                    parcel.writeString(c0844c.f3212h);
                }
                if (c0844c.f3213i == null || c0844c.f3213i.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3213i.length());
                    parcel.writeString(c0844c.f3213i);
                }
                if (c0844c.f3214j == null || c0844c.f3214j.isEmpty()) {
                    parcel.writeInt(0);
                } else {
                    parcel.writeInt(c0844c.f3214j.length());
                    parcel.writeString(c0844c.f3214j);
                }
                parcel.writeInt(c0844c.f3215k);
                parcel.writeInt(c0844c.f3216l);
            }
        }
    ...
    /* renamed from: a */
    private void m4468a(Parcel parcel) {
        String string;
        String string2;
        String string3;
        String string4;
        ...
        if (i == 0) {
            ...
            for (int i2 = i; i2 > 0; i2--) {
                ...
                this.userInfo.add(new C0844c(this, string, string2, string3, string4, string5, i3, i4, string6, string7, string8, parcel.readInt(), parcel.readInt()));
            }
        }
