...
public enum EnumC1764x {
    ...
    REASON_NETWORK_CHANGED_ON(HttpResponseCode.f13733OK),
    ...
    /* renamed from: a */
    public static EnumC1764x m7264a(int i) {
        switch (i) {
            case 0:
    ...
    /* renamed from: b */
    public long m7266b() {
        switch (C1765y.f6511a[m7264a(this.f6510m).ordinal()]) {
            case 1:
            case 2:
            case 4:
            case 6:
