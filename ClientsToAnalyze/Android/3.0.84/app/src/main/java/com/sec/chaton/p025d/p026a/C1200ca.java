...
public class C1200ca extends AbstractC1145a {
    public C1200ca(Handler handler, C1580h c1580h) {
    ...
    public String mo5496f() {
        C3250y.m11456e("beforeRequest", "GetPostONBlindListTask");
        return null;
    }
    ...
    public void mo5488a(C0267d c0267d) {
        C3250y.m11456e("afterRequest", "GetPostONBlindListTask");
        if ((!c0267d.m11704n() || c0267d.m1354e() == null || c0267d.m1351b() == EnumC1587o.ERROR) && CommonApplication.m11493l().getResources().getBoolean(R.bool.log_collector)) {
            C1533b.m6522a("01000004", "1201", c0267d);
        }
    }
}
