...
import com.sec.chaton.push.p051b.p053b.C2069i;
...
public class C2059c extends AbstractC2057a {
    public C2059c(Context context) {
        super(context);
    }
    ...
    protected ChannelPipelineFactory mo8181a() {
        return new C2069i(this.f7910a, true);
    }
    ...
    public synchronized Channel mo8180a(String str, int i, boolean z) {
        ...
        try {
            ((C2063c) channelMo8180a.getPipeline().get("message channel handler")).m8187a(C2045b.m8162a().m8173h());
