...
public class GlobalDisclaimerView extends BaseSinglePaneActivity {
    ...
    protected void onCreate(Bundle bundle) {
        this.f8358a = C3159aa.m10962a().m10979a("country_letter", "");
    ...
    protected Fragment mo1193a() {
        if (TextUtils.isEmpty(this.f8358a)) {
            m11543k().mo11584a(false);
            m11543k().mo11593d(false);
        }
        return new FragmentGlobalDisclaimer();
    }
    ...
    public int getDefaultTheme() {
        return TextUtils.isEmpty(this.f8358a) ? R.style.AppTheme_WithoutArrow : R.style.AppTheme;
    }

    @Override // com.sec.chaton.base.BaseActivity, com.sec.chaton.util.InterfaceC3226cn
    public int getBlackTheme() {
        return TextUtils.isEmpty(this.f8358a) ? R.style.AppTheme_Black_WithoutArrow : R.style.AppTheme_Black;
    }
}
