...
public class RenrenMessageFragment extends SnsMessageFragment implements InterfaceC2805u, InterfaceC2806v {

    /* renamed from: b */
    private C2735al f10052b = null;

    /* renamed from: c */
    private C2804t f10053c;

    protected RenrenMessageFragment() {
        this.f10053c = null;
        this.f10053c = new C2804t(this, Integer.parseInt("480"), "KSC5601");
        InputFilter[] inputFilterArr = {this.f10053c};
        m9968a(Integer.parseInt("480"));
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f10052b = new C2735al(this.f10235a);
    ...
    public void mo9713a(String str, String str2) {
        m9974c();
        this.f10052b.m9804a(str2, new C2826t(this));
    }
    ...
    public void mo9712a(Editable editable) {
        if (editable != null) {
            m9973b(this.f10053c.m10025a(editable.toString()));
        }
    }
}
