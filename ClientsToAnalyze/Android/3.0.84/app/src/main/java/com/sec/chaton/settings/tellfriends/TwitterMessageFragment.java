...
public class TwitterMessageFragment extends SnsMessageFragment implements InterfaceC2805u, InterfaceC2806v {

    /* renamed from: b */
    private C2737an f10059b;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f10059b = new C2737an(this.f10235a);
    ...
    public void mo9713a(String str, String str2) {
        m9974c();
        this.f10059b.m9813a(str2, new C2759bi(this));
    }
