...
public class ChatONLiveEventActivity extends BaseSinglePaneActivity {

    /* renamed from: a */
    static final String f10395a = ChatONLiveEventActivity.class.getSimpleName();

    /* renamed from: b */
    private InterfaceC0459d f10396b;

    @Override // com.sec.chaton.base.BaseSinglePaneActivity
    /* renamed from: a */
    protected Fragment mo1193a() {
        ChatONLiveEventFragment chatONLiveEventFragment = new ChatONLiveEventFragment();
        if (chatONLiveEventFragment instanceof InterfaceC0459d) {
            this.f10396b = chatONLiveEventFragment;
        }
        return chatONLiveEventFragment;
    }
    ...
    protected void onResume() {
        super.onResume();
        setTitle(R.string.setting_events);
        m10081c();
    }

    /* renamed from: c */
    private void m10081c() {
