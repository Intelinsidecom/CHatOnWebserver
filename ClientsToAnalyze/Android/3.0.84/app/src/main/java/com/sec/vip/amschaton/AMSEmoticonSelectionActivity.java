...
import com.sec.vip.amschaton.fragment.AMSEmoticonSelectionFragment;
import com.sec.vip.amschaton.fragment.InterfaceC3474av;

/* loaded from: classes.dex */
public class AMSEmoticonSelectionActivity extends BaseSinglePaneActivity implements InterfaceC3474av {
    @Override // com.sec.chaton.base.BaseSinglePaneActivity
    /* renamed from: a */
    protected Fragment mo1193a() {
        return new AMSEmoticonSelectionFragment();
    }
    ...
    public boolean onSupportOptionsItemSelected(MenuItem menuItem) {
        if (!super.onSupportOptionsItemSelected(menuItem) && menuItem.getItemId() == 16908332) {
            finish();
            return true;
        }
        return true;
