...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
    ...
    int getBytes(int i, GatheringByteChannel gatheringByteChannel, int i2);
    ...
    int readBytes(GatheringByteChannel gatheringByteChannel, int i);
    ...
    int setBytes(int i, InputStream inputStream, int i2);

    int setBytes(int i, ScatteringByteChannel scatteringByteChannel, int i2);
    ...
    int writeBytes(InputStream inputStream, int i);

    int writeBytes(ScatteringByteChannel scatteringByteChannel, int i);
