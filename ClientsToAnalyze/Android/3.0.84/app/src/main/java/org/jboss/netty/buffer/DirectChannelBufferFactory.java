...
public class DirectChannelBufferFactory extends AbstractChannelBufferFactory {
    ...
    public DirectChannelBufferFactory(ByteOrder byteOrder) {
        this(byteOrder, FeedPublishRequestParam.MESSAGE_TOO_LONG);
    }
    ...
    public ChannelBuffer getBuffer(ByteOrder byteOrder, int i) {
        ChannelBuffer channelBufferAllocateLittleEndianBuffer;
        if (byteOrder == null) {
        ...
        if (byteOrder == ByteOrder.BIG_ENDIAN) {
            channelBufferAllocateLittleEndianBuffer = allocateBigEndianBuffer(i);
        } else {
            channelBufferAllocateLittleEndianBuffer = allocateLittleEndianBuffer(i);
        }
        channelBufferAllocateLittleEndianBuffer.clear();
        return channelBufferAllocateLittleEndianBuffer;
    }
