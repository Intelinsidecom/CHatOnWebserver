...
public abstract class AbstractChannel implements Channel {
    ...
    /* renamed from: id */
    private final Integer f13685id;
    ...
    protected boolean setClosed() {
        allChannels.remove(this.f13685id);
    ...
    private String getIdString() {
        String hexString = Integer.toHexString(this.f13685id.intValue());
