...
public abstract class HttpContentDecoder extends SimpleChannelUpstreamHandler {
    ...
    protected abstract DecoderEmbedder<ChannelBuffer> newContentDecoder(String str);
    ...
    public void messageReceived(ChannelHandlerContext channelHandlerContext, MessageEvent messageEvent) {
        ...
        if (message instanceof HttpMessage) {
            ...
            if (httpMessage.isChunked() || httpMessage.getContent().readable()) {
                DecoderEmbedder<ChannelBuffer> decoderEmbedderNewContentDecoder = newContentDecoder(strTrim);
