...
public final class RtspResponseStatuses {
    ...
    /* renamed from: OK */
    public static final HttpResponseStatus f13705OK = HttpResponseStatus.f13704OK;
    ...
    public static final HttpResponseStatus MOVED_TEMPORARILY = new HttpResponseStatus(HttpResponseCode.FOUND, "Moved Temporarily");
