...
public class ChunkedNioFile implements ChunkedInput {
    ...
    /* renamed from: in */
    private final FileChannel f13710in;
    ...
    public boolean hasNextChunk() {
        return this.offset < this.endOffset && this.f13710in.isOpen();
    }
    ...
    public Object nextChunk() throws IOException {
        ...
        int i = 0;
        do {
            int i2 = this.f13710in.read(byteBufferWrap);
            if (i2 < 0) {
                break;
            }
            i += i2;
