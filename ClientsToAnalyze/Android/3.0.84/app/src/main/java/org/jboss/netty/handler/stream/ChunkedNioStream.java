...
public class ChunkedNioStream implements ChunkedInput {
    ...
    /* renamed from: in */
    private final ReadableByteChannel f13711in;
    ...
    public ChunkedNioStream(ReadableByteChannel readableByteChannel, int i) {
        ...
        this.f13711in = readableByteChannel;
        this.offset = 0L;
        this.chunkSize = i;
    ...
    public boolean hasNextChunk() {
        ...
        if (this.f13711in.isOpen() && (i = this.f13711in.read(this.byteBuffer)) >= 0) {
    ...
    public Object nextChunk() throws IOException {
        ...
        do {
            int i = this.f13711in.read(this.byteBuffer);
            if (i < 0) {
                break;
            }
            iPosition += i;
