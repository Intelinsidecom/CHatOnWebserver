...
public class HashedWheelTimer implements Timer {
    ...
    /* renamed from: id */
    private static final AtomicInteger f13713id = new AtomicInteger();
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long j, TimeUnit timeUnit, int i) {
        ...
        this.workerThread = threadFactory.newThread(new ThreadRenamingRunnable(this.worker, "Hashed wheel timer #" + f13713id.incrementAndGet()));
    ...
    public synchronized Set<Timeout> stop() {
        Set<Timeout> setUnmodifiableSet;
        synchronized (this) {
