...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    */
    public int size() {
        /*
            r15 = this;
            org.jboss.netty.util.internal.ConcurrentIdentityHashMap$Segment<K, V>[] r7 = r15.segments
            r3 = 0
            r1 = 0
            int r0 = r7.length
            int[] r8 = new int[r0]
    ...
    final class KeyIterator extends ConcurrentIdentityHashMap<K, V>.HashIterator implements Enumeration<K>, ReusableIterator<K> {
        KeyIterator() {
            super();
        }
    ...
    final class ValueIterator extends ConcurrentIdentityHashMap<K, V>.HashIterator implements Enumeration<V>, ReusableIterator<V> {
        ValueIterator() {
            super();
        }
    ...
    class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            return m13382eq(this.key, entry.getKey()) && m13382eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m13382eq(Object obj, Object obj2) {
