...
public final class ConcurrentIdentityWeakKeyHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    final class WeakKeyReference<K> extends WeakReference<K> {
        final int hash;
            ...
            if (this.count != 0) {
                for (HashEntry<K, V> hashEntry : this.table) {
                    for (; hashEntry != null; hashEntry = hashEntry.next) {
                        ...
                        if (obj2 == null) {
                            vDereferenceValue = readValueUnderLock(hashEntry);
                        } else {
                            vDereferenceValue = hashEntry.dereferenceValue(obj2);
                        }
                        if (obj.equals(vDereferenceValue)) {
                            return true;
                        }
                    }
                }
    ...
    */
    public int size() {
        /*
            r15 = this;
            org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$Segment<K, V>[] r7 = r15.segments
            r3 = 0
            r1 = 0
            int r0 = r7.length
            int[] r8 = new int[r0]
    ...
    final class KeyIterator extends ConcurrentIdentityWeakKeyHashMap<K, V>.HashIterator implements Enumeration<K>, ReusableIterator<K> {
        KeyIterator() {
            super();
        }
    ...
    final class ValueIterator extends ConcurrentIdentityWeakKeyHashMap<K, V>.HashIterator implements Enumeration<V>, ReusableIterator<V> {
        ValueIterator() {
            super();
        }
    ...
    class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            return m13383eq(this.key, entry.getKey()) && m13383eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m13383eq(Object obj, Object obj2) {
