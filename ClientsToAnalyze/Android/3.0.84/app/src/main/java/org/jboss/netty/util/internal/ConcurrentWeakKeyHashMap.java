...
public final class ConcurrentWeakKeyHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    */
    public int size() {
        /*
            r15 = this;
            org.jboss.netty.util.internal.ConcurrentWeakKeyHashMap$Segment<K, V>[] r7 = r15.segments
            r3 = 0
            r1 = 0
            int r0 = r7.length
            int[] r8 = new int[r0]
    ...
    final class KeyIterator extends ConcurrentWeakKeyHashMap<K, V>.HashIterator implements Enumeration<K>, ReusableIterator<K> {
        KeyIterator() {
            super();
        }
    ...
    final class ValueIterator extends ConcurrentWeakKeyHashMap<K, V>.HashIterator implements Enumeration<V>, ReusableIterator<V> {
        ValueIterator() {
            super();
        }
    ...
    class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            return m13384eq(this.key, entry.getKey()) && m13384eq(this.value, entry.getValue());
        }
        ...
        /* renamed from: eq */
        private static boolean m13384eq(Object obj, Object obj2) {
