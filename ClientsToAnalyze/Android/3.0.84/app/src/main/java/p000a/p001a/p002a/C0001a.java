...
public class C0001a {
    ...
    /* renamed from: e */
    public static final String[] f4e = {"id", "stream_id", "application_name", "category", PrefFragmentChats.TYPE, "title", "body", "image_url", "image_hints", "image_height", "image_width", "author_name", "author_image_url", "author_image_height", "author_image_width", "time_stamp", "more", "source"};
}
