...
public final class GeoQuery implements Serializable {
    ...
    HttpParameter[] asHttpParameterArray() {
        ...
        if (this.f13727ip != null) {
            appendParameter("ip", this.f13727ip, arrayList);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f13727ip == null ? geoQuery.f13727ip != null : !this.f13727ip.equals(geoQuery.f13727ip)) {
            return false;
        }
        if (this.location != null) {
    ...
    public int hashCode() {
        return (((((this.accuracy != null ? this.accuracy.hashCode() : 0) + (((this.f13727ip != null ? this.f13727ip.hashCode() : 0) + ((this.location != null ? this.location.hashCode() : 0) * 31)) * 31)) * 31) + (this.granularity != null ? this.granularity.hashCode() : 0)) * 31) + this.maxResults;
    }

    public String toString() {
        return new StringBuffer().append("GeoQuery{location=").append(this.location).append(", ip='").append(this.f13727ip).append('\'').append(", accuracy='").append(this.accuracy).append('\'').append(", granularity='").append(this.granularity).append('\'').append(", maxResults=").append(this.maxResults).append('}').toString();
    }
}
