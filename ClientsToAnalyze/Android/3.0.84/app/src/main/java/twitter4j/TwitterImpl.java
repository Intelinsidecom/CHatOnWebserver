...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
    ...
    @Override // twitter4j.api.TrendsMethods
    public ResponseList<Trends> getDailyTrends(Date date, boolean z) {
    ...
    @Override // twitter4j.api.TrendsMethods
    public ResponseList<Trends> getWeeklyTrends() {
    ...
    @Override // twitter4j.api.TrendsMethods
    public ResponseList<Trends> getWeeklyTrends(Date date, boolean z) {
    ...
    @Override // twitter4j.api.TimelineMethods
    public ResponseList<Status> getRetweetedToUser(String str, Paging paging) {
    ...
    @Override // twitter4j.api.TimelineMethods
    public ResponseList<Status> getRetweetedToUser(long j, Paging paging) {
    ...
    @Override // twitter4j.api.TimelineMethods
    public ResponseList<Status> getRetweetedByUser(String str, Paging paging) {
    ...
    @Override // twitter4j.api.TimelineMethods
    public ResponseList<Status> getRetweetedByUser(long j, Paging paging) {
    ...
    public ResponseList<User> getRetweetedBy(long j) {
        return getRetweetedBy(j, new Paging(1, 100));
    }

    @Override // twitter4j.api.StatusMethods
    public ResponseList<User> getRetweetedBy(long j, Paging paging) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFriendsStatuses(long j) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFriendsStatuses(String str, long j) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFriendsStatuses(long j, long j2) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFollowersStatuses(long j) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFollowersStatuses(String str, long j) {
    ...
    @Override // twitter4j.api.UserMethods
    public PagableResponseList<User> getFollowersStatuses(long j, long j2) {
    ...
    @Override // twitter4j.api.ListMethods
    public PagableResponseList<UserList> getUserLists(String str, long j) {
    ...
    @Override // twitter4j.api.ListMethods
    public PagableResponseList<UserList> getUserLists(long j, long j2) {
    ...
    @Override // twitter4j.api.ListMethods
    public ResponseList<Status> getUserListStatuses(String str, int i, Paging paging) {
        return getUserListStatuses(i, paging);
    }

    @Override // twitter4j.api.ListMethods
    public ResponseList<Status> getUserListStatuses(long j, int i, Paging paging) {
        return getUserListStatuses(i, paging);
    }
    ...
    @Override // twitter4j.api.ListMethods
    public ResponseList<UserList> getAllUserLists(String str) {
    ...
    @Override // twitter4j.api.ListMethods
    public ResponseList<UserList> getAllUserLists(long j) {
    ...
    public PagableResponseList<User> getUserListMembers(String str, int i, long j) {
    ...
    public PagableResponseList<User> getUserListSubscribers(String str, int i, long j) {
    ...
    public User updateProfileImage(File file) throws TwitterException {
        ...
        ensureAuthorizationEnabled();
        return this.factory.createUser(post(new StringBuffer().append(this.conf.getRestBaseURL()).append("account/update_profile_image.json").toString(), new HttpParameter[]{new HttpParameter(SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, file), this.INCLUDE_ENTITIES}));
    }

    @Override // twitter4j.api.AccountMethods
    public User updateProfileImage(InputStream inputStream) {
        ensureAuthorizationEnabled();
        return this.factory.createUser(post(new StringBuffer().append(this.conf.getRestBaseURL()).append("account/update_profile_image.json").toString(), new HttpParameter[]{new HttpParameter(SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, inputStream), this.INCLUDE_ENTITIES}));
    }
    ...
    public User updateProfileBackgroundImage(File file, boolean z) throws TwitterException {
        ensureAuthorizationEnabled();
        checkFileValidity(file);
        return this.factory.createUser(post(new StringBuffer().append(this.conf.getRestBaseURL()).append("account/update_profile_background_image.json").toString(), new HttpParameter[]{new HttpParameter(SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, file), new HttpParameter("tile", z), this.INCLUDE_ENTITIES}));
    }

    @Override // twitter4j.api.AccountMethods
    public User updateProfileBackgroundImage(InputStream inputStream, boolean z) {
        ensureAuthorizationEnabled();
        return this.factory.createUser(post(new StringBuffer().append(this.conf.getRestBaseURL()).append("account/update_profile_background_image.json").toString(), new HttpParameter[]{new HttpParameter(SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, SlookAirButtonRecentMediaAdapter.IMAGE_TYPE, inputStream), new HttpParameter("tile", z), this.INCLUDE_ENTITIES}));
    }
    ...
    @Override // twitter4j.api.FavoriteMethods
    public ResponseList<Status> getFavorites(int i) {
        ensureAuthorizationEnabled();
    ...
    @Override // twitter4j.api.FavoriteMethods
    public ResponseList<Status> getFavorites(String str, int i) {
        ensureAuthorizationEnabled();
    ...
    @Override // twitter4j.api.BlockMethods
    public ResponseList<User> getBlockingUsers(int i) {
        ensureAuthorizationEnabled();
    ...
    @Override // twitter4j.api.HelpMethods
    public ResponseList<HelpMethods.Language> getLanguages() {
