...
public class OAuthAuthorization implements Serializable, Authorization, OAuthSupport {
    ...
    public AccessToken getOAuthAccessToken(String str, String str2) throws TwitterException {
        try {
            ...
            this.oauthToken = new AccessToken(http.post(oAuthAccessTokenURL, new HttpParameter[]{new HttpParameter("x_auth_username", str), new HttpParameter("x_auth_password", str2), new HttpParameter("x_auth_mode", "client_auth")}, this));
            return (AccessToken) this.oauthToken;
    ...
    public static String normalizeAuthorizationHeaders(List<HttpParameter> list) {
        Collections.sort(list);
        return encodeParameters(list);
    }
