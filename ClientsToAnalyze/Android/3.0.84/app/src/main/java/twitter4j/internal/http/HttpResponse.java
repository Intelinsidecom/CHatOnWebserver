...
public abstract class HttpResponse {
    ...
    /* renamed from: is */
    protected InputStream f13732is;
    ...
    */
    ...
    public Reader asReader() {
        try {
            return new BufferedReader(new InputStreamReader(this.f13732is, "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            return new InputStreamReader(this.f13732is);
        }
    }
    ...
    public String toString() {
        return new StringBuffer().append("HttpResponse{statusCode=").append(this.statusCode).append(", responseAsString='").append(this.responseAsString).append('\'').append(", is=").append(this.f13732is).append(", streamConsumed=").append(this.streamConsumed).append('}').toString();
    }
}
