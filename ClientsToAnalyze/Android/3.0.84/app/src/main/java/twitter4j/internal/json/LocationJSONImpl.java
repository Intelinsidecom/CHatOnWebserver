...
final class LocationJSONImpl implements Location {
    ...
    LocationJSONImpl(JSONObject jSONObject) throws JSONException, TwitterException {
        try {
            ...
            this.url = z_T4JInternalParseUtil.getUnescapedString("url", jSONObject);
        } catch (JSONException e) {
            throw new TwitterException(e);
        }
    }

    static ResponseList<Location> createLocationList(HttpResponse httpResponse, Configuration configuration) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    static ResponseList<Location> createLocationList(JSONArray jSONArray, boolean z) throws JSONException, TwitterException {
        try {
