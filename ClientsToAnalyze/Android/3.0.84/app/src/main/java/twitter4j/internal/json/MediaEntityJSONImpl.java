...
public class MediaEntityJSONImpl implements MediaEntity {
    ...
    public MediaEntityJSONImpl(JSONObject jSONObject) throws JSONException, TwitterException {
        ...
        try {
            ...
            this.f13736id = z_T4JInternalParseUtil.getLong("id", jSONObject);
            try {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MediaEntityJSONImpl) && this.f13736id == ((MediaEntityJSONImpl) obj).f13736id;
    }

    public int hashCode() {
        return (int) (this.f13736id ^ (this.f13736id >>> 32));
    }

    public String toString() {
        return new StringBuffer().append("MediaEntityJSONImpl{id=").append(this.f13736id).append(", start=").append(this.start).append(", end=").append(this.end).append(", url=").append(this.url).append(", mediaURL=").append(this.mediaURL).append(", mediaURLHttps=").append(this.mediaURLHttps).append(", expandedURL=").append(this.expandedURL).append(", displayURL='").append(this.displayURL).append('\'').append(", sizes=").append(this.sizes).append('}').toString();
    }
}
