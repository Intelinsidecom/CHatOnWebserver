...
final class PlaceJSONImpl extends TwitterResponseImpl implements Serializable, Place {
    ...
    private void init(JSONObject jSONObject) throws JSONException, TwitterException {
        try {
            ...
            this.f13737id = z_T4JInternalParseUtil.getRawString("id", jSONObject);
            ...
            if (!jSONObject.isNull("place_type")) {
                ...
                this.placeType = z_T4JInternalParseUtil.getRawString(PrefFragmentChats.TYPE, jSONObject);
            }
            ...
            if (!jSONObject.isNull("bounding_box")) {
                ...
                this.boundingBoxType = z_T4JInternalParseUtil.getRawString(PrefFragmentChats.TYPE, jSONObject2);
            ...
            if (!jSONObject.isNull("geometry")) {
                ...
                this.geometryType = z_T4JInternalParseUtil.getRawString(PrefFragmentChats.TYPE, jSONObject3);
    ...
    public int compareTo2(Place place) {
        return this.f13737id.compareTo(place.getId());
    }

    static ResponseList<Place> createPlaceList(HttpResponse httpResponse, Configuration configuration) throws TwitterException, IOException {
    ...
    static ResponseList<Place> createPlaceList(JSONArray jSONArray, HttpResponse httpResponse, Configuration configuration) throws IllegalAccessException, JSONException, TwitterException, IllegalArgumentException, InvocationTargetException {
        if (configuration.isJSONStoreEnabled()) {
            DataObjectFactoryUtil.clearThreadLocalMap();
        }
        try {
