...
public class z_T4JInternalJSONImplFactory implements z_T4JInternalFactory {
    ...
    @Override // twitter4j.internal.json.z_T4JInternalFactory
    public ResponseList<Trends> createTrendsList(HttpResponse httpResponse) {
    ...
    @Override // twitter4j.internal.json.z_T4JInternalFactory
    public ResponseList<HelpMethods.Language> createLanguageList(HttpResponse httpResponse) {
