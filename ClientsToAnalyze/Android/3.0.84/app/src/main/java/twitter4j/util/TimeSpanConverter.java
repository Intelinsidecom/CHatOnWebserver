...
public final class TimeSpanConverter implements Serializable {
    ...
    public String toTimeSpanString(long j) {
        ...
        if (iCurrentTimeMillis >= ONE_DAY_IN_SECONDS) {
            if (iCurrentTimeMillis >= ONE_MONTH_IN_SECONDS) {
                return this.dateMonthYear.format(new Date(j));
            }
            return this.dateMonth.format(new Date(j));
        }
        return toTimeSpanString(iCurrentTimeMillis);
    }
    ...
    private String toTimeSpanString(int i) {
        ...
        if (i < 60) {
            return this.formats[1].format(new Object[]{new Integer(i)});
        }
        if (i < 2700) {
            int i2 = i / 60;
            return i2 == 1 ? this.formats[2].format(null) : this.formats[3].format(new Object[]{new Integer(i2)});
        }
        if (i < 6300) {
            return this.formats[4].format(null);
        }
        return this.formats[5].format(new Object[]{new Integer((i + 900) / ONE_HOUR_IN_SECONDS)});
    }
}
