...
public class DirectMessage extends WeiboResponse implements Serializable {
    ...
    DirectMessage(JSONObject jSONObject) throws WeiboException {
        try {
            this.f13748id = jSONObject.getInt("id");
    ...
    private void init(Response response, Element element, Weibo weibo) {
        ...
        this.f13748id = getChildInt("id", element);
    ...
    public boolean equals(Object obj) {
        ...
        if (this != obj) {
            return (obj instanceof DirectMessage) && ((DirectMessage) obj).f13748id == this.f13748id;
        }
        return true;
    }

    public String toString() {
        return "DirectMessage{id=" + this.f13748id + ", text='" + this.text + "', sender_id=" + this.sender_id + ", recipient_id=" + this.recipient_id + ", created_at=" + this.created_at + ", sender_screen_name='" + this.sender_screen_name + "', recipient_screen_name='" + this.recipient_screen_name + "', sender=" + this.sender + ", recipient=" + this.recipient + '}';
    }
}
