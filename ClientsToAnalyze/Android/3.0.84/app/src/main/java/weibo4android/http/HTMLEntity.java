...
public class HTMLEntity {
    ...
    public static void escape(StringBuffer stringBuffer) {
        ...
        while (true) {
            ...
            if (i < stringBuffer.length()) {
                String str = entityEscapeMap.get(stringBuffer.substring(i, i + 1));
                if (str != null) {
    ...
    public static void unescape(StringBuffer stringBuffer) {
        ...
        int iIndexOf2;
        int i = 0;
        while (i < stringBuffer.length() && -1 != (iIndexOf = stringBuffer.indexOf("&", i)) && -1 != (iIndexOf2 = stringBuffer.indexOf(Config.KEYVALUE_SPLIT, iIndexOf)) && 10 > iIndexOf2 - iIndexOf) {
            String str = escapeEntityMap.get(stringBuffer.substring(iIndexOf, iIndexOf2 + 1));
            if (str != null) {
                stringBuffer.replace(iIndexOf, iIndexOf2 + 1, str);
            }
            i = iIndexOf + 1;
        }
    }
