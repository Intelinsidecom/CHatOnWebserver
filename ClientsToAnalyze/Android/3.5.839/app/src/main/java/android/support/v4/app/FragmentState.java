...
final class FragmentState implements Parcelable {
    public static final Parcelable.Creator<FragmentState> CREATOR = new C0019ae();
    ...
    /* renamed from: a */
    public Fragment m53a(FragmentActivity fragmentActivity, Fragment fragment) {
        ...
        this.mInstance.mFragmentManager = fragmentActivity.f45b;
        if (C0071y.f210a) {
