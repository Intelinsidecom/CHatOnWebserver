...
final class C0573ag extends AbstractC0562ae<StringBuilder> {
    C0573ag() {
    }

    @Override // com.google.p034a.AbstractC0562ae
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public StringBuilder mo1949b(C0666a c0666a) throws IOException {
        if (c0666a.mo1992f() != EnumC0668c.NULL) {
            return new StringBuilder(c0666a.mo1994h());
        }
        c0666a.mo1996j();
        return null;
    }
    ...
    public void mo1948a(C0669d c0669d, StringBuilder sb) throws IOException {
        c0669d.mo2010b(sb == null ? null : sb.toString());
    }
}
