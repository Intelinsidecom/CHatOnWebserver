...
final class C0574ah extends AbstractC0562ae<StringBuffer> {
    C0574ah() {
    }

    @Override // com.google.p034a.AbstractC0562ae
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public StringBuffer mo1949b(C0666a c0666a) throws IOException {
        if (c0666a.mo1992f() != EnumC0668c.NULL) {
            return new StringBuffer(c0666a.mo1994h());
        }
        c0666a.mo1996j();
        return null;
    }
    ...
    public void mo1948a(C0669d c0669d, StringBuffer stringBuffer) throws IOException {
        c0669d.mo2010b(stringBuffer == null ? null : stringBuffer.toString());
    }
}
