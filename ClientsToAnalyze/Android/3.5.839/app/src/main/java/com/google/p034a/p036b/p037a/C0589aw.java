...
final class C0589aw implements InterfaceC0563af {

    /* renamed from: a */
    final /* synthetic */ Class f1385a;

    /* renamed from: b */
    final /* synthetic */ Class f1386b;

    /* renamed from: c */
    final /* synthetic */ AbstractC0562ae f1387c;

    C0589aw(Class cls, Class cls2, AbstractC0562ae abstractC0562ae) {
        this.f1385a = cls;
        this.f1386b = cls2;
        this.f1387c = abstractC0562ae;
    }
    ...
    public <T> AbstractC0562ae<T> mo1950a(C0676j c0676j, C0664a<T> c0664a) {
        ...
        if (clsM2103a == this.f1385a || clsM2103a == this.f1386b) {
            return this.f1387c;
        }
        return null;
    }
    ...
    public String toString() {
        return "Factory[type=" + this.f1385a.getName() + "+" + this.f1386b.getName() + ",adapter=" + this.f1387c + "]";
    }
}
