...
public class AMSLibs {
    ...
    public native boolean VipAMS_AddObjectImage(int i, byte b2, int[] iArr, int i2, int i3, int i4, short s);
    ...
    public native boolean VipAMS_ChangeSelectDiagram(int i, AMS_SELECT_OBJECT ams_select_object, AMS_RECT ams_rect, byte b2);
    ...
    public native boolean VipAMS_ChangeSelectText(int i, AMS_SELECT_OBJECT ams_select_object, AMS_RECT ams_rect, byte b2, char[] cArr, short s, char[] cArr2, short s2);
    ...
    public native boolean VipAMS_EncodeNewDiagram(int i, AMS_RECT ams_rect, byte b2);

    public native int VipAMS_EncodeNewMultiImage(int i, AMS_RECT ams_rect, byte b2, byte b3);

    public native boolean VipAMS_EncodeNewStamp(int i, AMS_RECT ams_rect, byte b2, byte b3, byte b4, int[] iArr, int i2, int i3, int i4);

    public native boolean VipAMS_EncodeNewText(int i, AMS_RECT ams_rect, byte b2, char[] cArr, short s, char[] cArr2, short s2);
    ...
    public native int[] VipAMS_GetObjectImageBuf(int i, AMS_OBJECT_DATA ams_object_data, byte b2);

    public native int VipAMS_GetObjectImageDuration(int i, AMS_OBJECT_DATA ams_object_data, byte b2);
    ...
    public native boolean VipAMS_RemoveFrame(int i, byte b2);
    ...
    public native boolean VipAMS_SetBackgroundIndex(int i, byte b2);
    ...
    public native boolean VipAMS_SetCurObjectSize(int i, byte b2);

    public native boolean VipAMS_SetCurObjectStyle(int i, byte b2);

    public native boolean VipAMS_SetCurObjectType(int i, byte b2);

    public native boolean VipAMS_SetCurrentFrame(int i, byte b2);
    ...
    public native boolean VipAMS_SetTurnPageOption(int i, byte b2);
    ...
    */
        ...
        while (true) {
            ...
            if (iCallback_saveRawImageToImageFile == 0) {
                ...
                try {
                    ...
                    C4904y.m18634a("IOException", getClass().getSimpleName());
                    i7 = length;
                }
                if (i8 < 5) {
                    i6 = 43;
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x001e A[Catch: IOException -> 0x003c, TRY_ENTER, TRY_LEAVE, TryCatch #1 {IOException -> 0x003c, blocks: (B:10:0x001e, B:14:0x002d), top: B:22:0x002d }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public int Callback_loadImageStreamToRawImage(byte[] r4, byte[] r5, int r6) throws java.io.IOException {
        ...
        L18:
            r1 = 0
            r0.write(r5, r1, r6)     // Catch: java.io.IOException -> L4c
        L1c:
            if (r0 == 0) goto L21
        ...
        L2d:
            ...
            java.lang.Class r2 = r3.getClass()     // Catch: java.io.IOException -> L3c
            java.lang.String r2 = r2.getSimpleName()     // Catch: java.io.IOException -> L3c
            com.sec.chaton.util.C4904y.m18634a(r1, r2)     // Catch: java.io.IOException -> L3c
            goto L1c
        L3c:
            r0 = move-exception
    ...
    */
    public boolean Callback_writeData(byte[] r8, int r9, byte[] r10) throws java.lang.Throwable {
        ...
        L6:
            r3 = 0
            java.lang.String r1 = new java.lang.String     // Catch: java.io.IOException -> L32 java.lang.Throwable -> L42
            r1.<init>(r8)     // Catch: java.io.IOException -> L32 java.lang.Throwable -> L42
            java.io.RandomAccessFile r2 = new java.io.RandomAccessFile     // Catch: java.io.IOException -> L32 java.lang.Throwable -> L42
            java.lang.String r4 = "rw"
            r2.<init>(r1, r4)     // Catch: java.io.IOException -> L32 java.lang.Throwable -> L42
            if (r9 < 0) goto L26
            long r3 = (long) r9
            long r5 = r2.length()     // Catch: java.lang.Throwable -> L4e java.io.IOException -> L51
            int r1 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r1 >= 0) goto L26
            long r3 = (long) r9     // Catch: java.lang.Throwable -> L4e java.io.IOException -> L51
            r2.seek(r3)     // Catch: java.lang.Throwable -> L4e java.io.IOException -> L51
            r2.write(r10)     // Catch: java.lang.Throwable -> L4e java.io.IOException -> L51
        L26:
            if (r2 == 0) goto L2b
