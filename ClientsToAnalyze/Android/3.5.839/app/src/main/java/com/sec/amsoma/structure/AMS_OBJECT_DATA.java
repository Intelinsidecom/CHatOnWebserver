...
public class AMS_OBJECT_DATA {
    ...
    public void setM_nIsThisSimplified(byte b2) {
        this.m_nIsThisSimplified = b2;
    }
    ...
    public void setM_cSize(byte b2) {
        this.m_cSize = b2;
    }
    ...
    public int getM_nRotation() {
        return this.m_nRotation;
    }

    public void setM_nRotation(int i) {
        this.m_nRotation = i;
    }
}
