...
/* renamed from: com.sec.chaton.chat.a.k */
/* loaded from: classes.dex */
public class C1538k extends AbstractC1525as {
    @Override // com.sec.chaton.chat.p054a.AbstractViewOnClickListenerC1514ah
    /* renamed from: a */
    public String mo8368a(Context context) {
        return context.getString(R.string.media_event);
    }
    ...
    protected void mo8357a() {
        ...
        imageView.setContentDescription(this.f5856c.getString(R.string.media_event));
    }
    ...
    public void onClick(View view) {
        ...
        if (!this.f5858e.isClosed()) {
            if ((view.equals(this.f5861h.f6408Z) || view.equals(this.f5861h.f6481z)) && this.f5858e.moveToPosition(this.f5859f)) {
                this.f5864k.mo8249c(m8404s(), this.f5858e, this.f5861h.f6409a);
            }
        }
    }
}
