...
public class TranslationAuthEntry extends Entry {
    ...
    public String getUrlPrimary() {
        return getUrl(EnumC2408a.PRIMARY);
    }

    public String getUrlSecondary() {
        return getUrl(EnumC2408a.SECONDARY);
    }

    private String getUrl(EnumC2408a enumC2408a) throws NumberFormatException {
        List<Server> list;
        try {
            parseMore();
            ...
            if (enumC2408a == EnumC2408a.PRIMARY) {
    ...
    private boolean parseMore() throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            server.port = jSONObject.getString(Config.COLUMN_PORT);
        ...
        for (int i2 = 0; i2 < length2; i2++) {
            ...
            server2.port = jSONObject2.getString(Config.COLUMN_PORT);
