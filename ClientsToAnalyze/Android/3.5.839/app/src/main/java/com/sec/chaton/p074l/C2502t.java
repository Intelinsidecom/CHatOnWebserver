...
/* renamed from: com.sec.chaton.l.t */
/* loaded from: classes.dex */
class C2502t extends AbstractRunnableC5005a<String> implements InterfaceC2493k {

    /* renamed from: a */
    private String f8964a;

    /* renamed from: b */
    private EnumC2498p f8965b;

    public C2502t(String str, EnumC2498p enumC2498p) {
        super(str);
        this.f8964a = str;
        this.f8965b = enumC2498p;
    }

    @Override // com.sec.common.p132g.AbstractRunnableC5005a
    /* renamed from: m_ */
    public void mo7450m_() {
        mo7449h().setImageDrawable(C2496n.m10769b(this.f8965b));
    }
    ...
    public Object mo7444c() throws IOException {
        try {
            return new CallableC2490h(m18997k(), this.f8964a, EnumC2508z.LOAD).call();
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
    ...
    public void mo7443a(Object obj, boolean z) {
        ...
        if (bitmap != null && bitmap != C2496n.f8946a) {
            if (this.f8965b == EnumC2498p.ROUND) {
        ...
        mo7449h().setImageDrawable(C2496n.m10754a(this.f8965b));
    }
