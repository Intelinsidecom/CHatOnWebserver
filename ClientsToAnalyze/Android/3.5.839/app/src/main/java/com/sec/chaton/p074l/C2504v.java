...
/* renamed from: com.sec.chaton.l.v */
/* loaded from: classes.dex */
class C2504v extends AbstractRunnableC5005a<String> implements InterfaceC2493k {
    ...
    /* renamed from: c */
    private EnumC2498p f8969c;

    public C2504v(String str, EnumC2498p enumC2498p) {
        this(str, 160, enumC2498p);
    }

    public C2504v(String str, int i, EnumC2498p enumC2498p) {
        super(str + i);
        this.f8967a = str;
        this.f8968b = i;
        this.f8969c = enumC2498p;
    }

    @Override // com.sec.common.p132g.AbstractRunnableC5005a
    /* renamed from: m_ */
    public void mo7450m_() {
        mo7449h().setImageDrawable(C2496n.m10779c(this.f8969c));
    }
    ...
    public Object mo7444c() throws IOException {
        try {
            return new CallableC2491i(m18997k(), this.f8967a, EnumC2508z.LOAD, this.f8968b).call();
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
    ...
    public void mo7443a(Object obj, boolean z) {
        ...
        if (bitmap != null && bitmap != C2496n.f8946a) {
            if (this.f8969c == EnumC2498p.ROUND) {
