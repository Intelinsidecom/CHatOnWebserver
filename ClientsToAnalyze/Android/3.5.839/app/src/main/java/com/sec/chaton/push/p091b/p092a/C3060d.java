...
import com.sec.chaton.push.p091b.p093b.C3070j;
...
public class C3060d extends AbstractC3057a {
    ...
    protected ChannelPipelineFactory mo12524a() {
        return new C3070j(this.f11320a, true);
    }
    ...
    public synchronized Channel mo12523a(String str, int i, boolean z) {
        ...
        try {
            ((C3063c) channelMo12523a.getPipeline().get("message channel handler")).m12530a(C3045b.m12505a().m12517i());
