...
public class C3117i {
    ...
    /* renamed from: a */
    private static final Intent f11464a = new Intent("com.sec.spp.push.PUSH_CLIENT_SERVICE_ACTION");

    /* renamed from: a */
    public static boolean m12712a(Context context) {
        return context.getPackageManager().resolveService(f11464a, 32) != null;
    }

    /* renamed from: a */
    public static void m12710a(Context context, boolean z) {
        m12711a(context, z, null, 0L);
    }

    /* renamed from: a */
    public static void m12711a(Context context, boolean z, Intent intent, long j) {
    ...
    /* renamed from: b */
    public static void m12713b(Context context, boolean z) {
        m12714b(context, z, null, 0L);
    }

    /* renamed from: b */
    public static void m12714b(Context context, boolean z, Intent intent, long j) {
        if (z && intent != null) {
            ((AlarmManager) context.getSystemService("alarm")).set(2, SystemClock.elapsedRealtime() + j, PendingIntent.getBroadcast(context, 0, intent, 0));
        }
        PackageManager packageManager = context.getPackageManager();
