...
public class FlickImageLayout extends Fragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle != null && bundle.containsKey("position_data")) {
            this.f12177a = bundle.getInt("position_data");
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (getResources().getConfiguration().orientation == 2) {
            viewInflate = layoutInflater.inflate(R.layout.layout_multi_device_flicking_land, viewGroup, false);
        } else {
            viewInflate = layoutInflater.inflate(R.layout.layout_multi_device_flicking, viewGroup, false);
        }
    ...
    public void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("position_data", this.f12177a);
