...
public class C3574dk extends AbstractRunnableC5005a<String> {

    /* renamed from: a */
    Context f13064a;

    public C3574dk(String str, Context context) {
        super(str);
    ...
    public Object mo7444c() {
        return C3474r.m13838g(this.f13064a, m18996j().split("_")[1]);
    }
