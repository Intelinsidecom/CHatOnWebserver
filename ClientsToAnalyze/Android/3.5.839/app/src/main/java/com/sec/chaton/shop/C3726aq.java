...
/* renamed from: com.sec.chaton.shop.aq */
/* loaded from: classes.dex */
public class C3726aq {

    /* renamed from: a */
    private static final String f13400a = C3726aq.class.getSimpleName();

    /* renamed from: b */
    private AlertDialogC4916i f13401b;

    /* renamed from: c */
    private Context f13402c;

    /* renamed from: d */
    private Handler f13403d;

    /* renamed from: e */
    private Handler f13404e = new HandlerC3727ar(this);
  ...
  0x0077: PHI (r1v6 android.database.Cursor) = (r1v5 android.database.Cursor), (r1v9 android.database.Cursor) binds: [B:15:0x0075, B:28:0x00bd] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public void m14059a(com.sec.chaton.shop.entrys.DownloadRequestEntry r13) throws java.lang.Throwable {
        /*
            r12 = this;
            r11 = 2
            r10 = 1
        ...
        L34:
            ...
            java.lang.String r2 = com.sec.chaton.shop.C3726aq.f13400a     // Catch: java.io.IOException -> L71 java.lang.Throwable -> Lc0
        ...
        Lc2:
            ...
            goto L72
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.chaton.shop.C3726aq.m14059a(com.sec.chaton.shop.entrys.DownloadRequestEntry):void");
    }

    public C3726aq(Context context, DownloadRequestEntry downloadRequestEntry, Handler handler) {
        this.f13402c = context;
        this.f13403d = handler;
        m14062b(downloadRequestEntry);
    }

    /* renamed from: b */
    private void m14062b(DownloadRequestEntry downloadRequestEntry) {
        ...
        if (string != null && str != null && str2 != null) {
            ...
            if (c3447n == null) {
                ...
                c3447n2.m13716a(this.f13404e);
                c3447n2.m19059d(new Void[0]);
                m14060a(string, i);
                return;
            }
            if (c3447n.m13721e() == 5) {
                C3447n c3447n3 = new C3447n(downloadRequestEntry);
                c3447n3.m13716a(this.f13404e);
                c3447n3.m19059d(new Void[0]);
                m14060a(string, i);
            }
        }
    }
    ...
    /* renamed from: a */
    private void m14060a(String str, int i) {
        if (this.f13401b == null) {
            this.f13401b = new AlertDialogC4916i(this.f13402c);
            if (i == 0) {
                this.f13401b.setTitle(R.string.download_title);
                this.f13401b.setMessage(this.f13402c.getResources().getString(R.string.anicon_file_downloading));
            } else if (i == 1) {
                this.f13401b.setTitle(R.string.setting_update_text);
                this.f13401b.setMessage(this.f13402c.getResources().getString(R.string.interaction_updating));
            }
            this.f13401b.setCancelable(false);
        }
        this.f13401b.setButton(-2, this.f13402c.getResources().getString(R.string.dialog_cancel), new DialogInterfaceOnClickListenerC3728as(this, str));
        this.f13401b.show();
        this.f13401b.m18719a(0);
    }
}
