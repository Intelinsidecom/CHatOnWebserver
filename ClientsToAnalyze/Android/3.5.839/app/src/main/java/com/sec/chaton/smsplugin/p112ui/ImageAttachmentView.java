...
public class ImageAttachmentView extends LinearLayout implements InterfaceC4315ih {
    ...
    protected void onFinishInflate() {
        this.f14784a = (ImageView) findViewById(R.id.image_content);
    }
    ...
    public void setImage(String str, Bitmap bitmap) {
        if (bitmap == null) {
            try {
                ...
                C3890m.m14995a("ImageAttachmentView", "setImage: out of memory: ", e);
                return;
            }
        }
        this.f14784a.setImageBitmap(bitmap);
    }
