...
public class VideoAttachmentView extends LinearLayout implements InterfaceC4315ih {
    ...
    protected void onFinishInflate() {
        this.f15214a = (ImageView) findViewById(R.id.video_thumbnail);
    }
    ...
    public void setVideo(String str, Uri uri) throws IOException {
        try {
            Bitmap bitmapM16286a = m16286a(this.mContext, uri);
            if (bitmapM16286a == null) {
                bitmapM16286a = BitmapFactory.decodeResource(getResources(), R.drawable.ic_missing_thumbnail_video);
            }
            this.f15214a.setImageBitmap(bitmapM16286a);
        } catch (OutOfMemoryError e) {
            C3890m.m14995a("VideoAttachmentView", "setVideo: out of memory: ", e);
        }
    }

    /* renamed from: a */
    public static Bitmap m16286a(Context context, Uri uri) throws IOException {
