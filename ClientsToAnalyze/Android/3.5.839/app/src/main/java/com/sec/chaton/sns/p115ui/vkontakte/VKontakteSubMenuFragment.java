...
public class VKontakteSubMenuFragment extends SnsSubMenuFragment {

    /* renamed from: g */
    private static final String f16261g = VKontakteSubMenuFragment.class.getSimpleName();

    /* renamed from: h */
    private Activity f16262h;

    /* renamed from: i */
    private View f16263i;

    /* renamed from: j */
    private C4388an f16264j;

    @Override // com.sec.chaton.sns.p115ui.SnsSubMenuFragment, android.support.v4.app.Fragment
    public void onAttach(Activity activity) {
        this.f16264j = new C4388an(activity);
        super.onAttach(activity);
        this.f16262h = activity;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f16263i = super.onCreateView(layoutInflater, viewGroup, bundle);
        return this.f16263i;
    }
    ...
    public void mo16915b() {
        if (this.f16264j.mo16650e()) {
            m16913a(this.f16264j.mo16647b());
            m17100j();
        } else {
            m16919f();
            ...
            this.f16264j.mo16641a(new C4517b(this));
        }
    }
    ...
    public void m17100j() {
        ...
        m16914a(true);
        this.f16264j.mo16644a(this.f16056f);
    }

    @Override // com.sec.chaton.sns.p115ui.InterfaceC4511t
    /* renamed from: a */
    public void mo16888a(C4379ae c4379ae) {
        Intent intent = new Intent(this.f16262h, (Class<?>) VKontakteMessageActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sns_account_layout /* 2131166261 */:
                Intent intent = new Intent(this.f16262h, (Class<?>) ActivityManageAccounts.class);
                intent.putExtra("INTENT_FROM", "VKONTAKTE_SUB_MENU");
                startActivity(intent);
                break;
            case R.id.sns_invitation_layout /* 2131166262 */:
                Intent intent2 = new Intent(this.f16262h, (Class<?>) VKontakteMessageActivity.class);
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 3001 && !this.f16264j.mo16650e()) {
            this.f16262h.finish();
        }
    }
