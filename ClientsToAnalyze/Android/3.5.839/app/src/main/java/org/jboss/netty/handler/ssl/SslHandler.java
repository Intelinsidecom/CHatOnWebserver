...
public class SslHandler extends FrameDecoder implements ChannelDownstreamHandler, LifeCycleAwareChannelHandler {
    ...
    */
    ...
    private void flushPendingEncryptedWrites(ChannelHandlerContext channelHandlerContext) {
        ...
        while (true) {
            try {
                MessageEvent messageEventPoll = this.pendingEncryptedWrites.poll();
        ...
        do {
            try {
                try {
                    ...
                    switch (C52723.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus.ordinal()]) {
                        case 1:
                        case 5:
                            break;
                        case 2:
    ...
    */
    private org.jboss.netty.buffer.ChannelBuffer unwrap(org.jboss.netty.channel.ChannelHandlerContext r9, org.jboss.netty.channel.Channel r10, org.jboss.netty.buffer.ChannelBuffer r11, int r12, int r13) {
        ...
        Lc:
            java.lang.Object r4 = r8.handshakeLock     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            monitor-enter(r4)     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            boolean r5 = r8.handshaken     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L32
            boolean r5 = r8.handshaking     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L32
            javax.net.ssl.SSLEngine r5 = r8.engine     // Catch: java.lang.Throwable -> L64
            boolean r5 = r5.getUseClientMode()     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L32
            javax.net.ssl.SSLEngine r5 = r8.engine     // Catch: java.lang.Throwable -> L64
            boolean r5 = r5.isInboundDone()     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L32
            javax.net.ssl.SSLEngine r5 = r8.engine     // Catch: java.lang.Throwable -> L64
            boolean r5 = r5.isOutboundDone()     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L32
            r8.handshake()     // Catch: java.lang.Throwable -> L64
        L32:
            javax.net.ssl.SSLEngine r5 = r8.engine     // Catch: java.lang.Throwable -> L64
            javax.net.ssl.SSLEngineResult r5 = r5.unwrap(r2, r3)     // Catch: java.lang.Throwable -> L64
            javax.net.ssl.SSLEngineResult$HandshakeStatus r5 = r5.getHandshakeStatus()     // Catch: java.lang.Throwable -> L64
            r8.handleRenegotiation(r5)     // Catch: java.lang.Throwable -> L64
            int[] r6 = org.jboss.netty.handler.ssl.SslHandler.C52723.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus     // Catch: java.lang.Throwable -> L64
            int r7 = r5.ordinal()     // Catch: java.lang.Throwable -> L64
            r6 = r6[r7]     // Catch: java.lang.Throwable -> L64
            switch(r6) {
                case 1: goto Lbc;
                case 2: goto L73;
                case 3: goto Lc0;
        ...
        L4a:
            ...
            java.lang.StringBuilder r1 = r1.append(r5)     // Catch: java.lang.Throwable -> L64
        ...
        L64:
            ...
            throw r0     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
        L67:
            r0 = move-exception
            r8.setHandshakeFailure(r10, r0)     // Catch: java.lang.Throwable -> L6c
        ...
        L6c:
            ...
            throw r0
        L73:
            boolean r5 = r2.hasRemaining()     // Catch: java.lang.Throwable -> L64
            if (r5 == 0) goto L83
            javax.net.ssl.SSLEngine r5 = r8.engine     // Catch: java.lang.Throwable -> L64
            boolean r5 = r5.isInboundDone()     // Catch: java.lang.Throwable -> L64
            if (r5 != 0) goto L83
        ...
        L84:
            if (r0 == 0) goto L99
            java.lang.Object r0 = r8.handshakeLock     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            boolean r0 = java.lang.Thread.holdsLock(r0)     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            if (r0 != 0) goto L99
            org.jboss.netty.util.internal.NonReentrantLock r0 = r8.pendingEncryptedWritesLock     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            boolean r0 = r0.isHeldByCurrentThread()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            if (r0 != 0) goto L99
            r8.wrap(r9, r10)     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
        L99:
            r3.flip()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            boolean r0 = r3.hasRemaining()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            if (r0 == 0) goto Lcd
            int r0 = r3.remaining()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            org.jboss.netty.buffer.ChannelBuffer r0 = org.jboss.netty.buffer.ChannelBuffers.buffer(r0)     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            byte[] r1 = r3.array()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            r2 = 0
            int r4 = r0.capacity()     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            r0.writeBytes(r1, r2, r4)     // Catch: javax.net.ssl.SSLException -> L67 java.lang.Throwable -> L6c
            org.jboss.netty.handler.ssl.SslBufferPool r1 = r8.bufferPool
        Lb8:
            r1.release(r3)
            return r0
        Lbc:
            r8.wrapNonAppData(r9, r10)     // Catch: java.lang.Throwable -> L64
            goto L81
        Lc0:
            r8.runDelegatedTasks()     // Catch: java.lang.Throwable -> L64
            goto L81
        Lc4:
            r8.setHandshakeSuccess(r10)     // Catch: java.lang.Throwable -> L64
            monitor-exit(r4)     // Catch: java.lang.Throwable -> L64
            r0 = r1
            goto L84
        Lca:
    ...
    final class ClosingChannelFutureListener implements ChannelFutureListener {
        ...
        /* renamed from: e */
        private final ChannelStateEvent f19099e;

        ClosingChannelFutureListener(ChannelHandlerContext channelHandlerContext, ChannelStateEvent channelStateEvent) {
            this.context = channelHandlerContext;
            this.f19099e = channelStateEvent;
        }

        @Override // org.jboss.netty.channel.ChannelFutureListener
        public void operationComplete(ChannelFuture channelFuture) {
            if (!(channelFuture.getCause() instanceof ClosedChannelException)) {
                Channels.close(this.context, this.f19099e.getFuture());
            } else {
                this.f19099e.getFuture().setSuccess();
            }
        }
    }
