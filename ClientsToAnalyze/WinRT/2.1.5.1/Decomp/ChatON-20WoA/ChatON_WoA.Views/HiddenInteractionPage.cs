...
public sealed class HiddenInteractionPage : Page, IComponentConnector
{
	private readonly HiddenInteractionPageViewModel _viewModel;

	private static HiddenInteractionPage _activeInstance;

	[GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
	private Grid LayoutRoot;

	[GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
	private Image NoBlockListImage;
	...
	public HiddenInteractionPageViewModel ViewModel => _viewModel;

	public static HiddenInteractionPage ActiveInstance => _activeInstance;

	public HiddenInteractionPage()
	{
		InitializeComponent();
		_activeInstance = this;
		_viewModel = new HiddenInteractionPageViewModel(this);
	...
	public void EnableRemoveButton()
	{
		...
		((Control)RemoveBlockBuddy).put_IsEnabled(_viewModel.HideList.Count((Buddy x) => x.IsChecked) > 0);
	}
	...
	private void CheckAllBlockBuddyButton_OnTapped(object sender, TappedRoutedEventArgs e)
	{
		_viewModel.CheckAllHideInteractionList();
	}
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Application.LoadComponent((object)this, new Uri("ms-appx:///HiddenInteractionPage.xaml"), (ComponentResourceLocation)0);
			LayoutRoot = (Grid)((FrameworkElement)this).FindName("LayoutRoot");
			NoBlockListImage = (Image)((FrameworkElement)this).FindName("NoBlockListImage");
