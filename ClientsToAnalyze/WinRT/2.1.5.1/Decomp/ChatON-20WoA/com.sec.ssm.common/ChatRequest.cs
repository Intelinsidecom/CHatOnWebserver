...
public sealed class ChatRequest : GeneratedMessage<ChatRequest, ChatRequest.Builder>
{
	...
	public const int LastSessionMergeTimestampFieldNumber = 11;
	...
	public override int SerializedSize
	{
		get
		{
			...
			{
				num += CodedOutputStream.ComputeInt64Size(11, LastSessionMergeTimestamp);
			}
	...
	public override void WriteTo(CodedOutputStream output)
	{
		...
		if (HasLastSessionMergeTimestamp)
		{
			output.WriteInt64(11, LastSessionMergeTimestamp);
		}
