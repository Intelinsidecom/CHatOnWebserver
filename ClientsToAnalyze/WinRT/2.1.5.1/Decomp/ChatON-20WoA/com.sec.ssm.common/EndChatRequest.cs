...
public sealed class EndChatRequest : GeneratedMessage<EndChatRequest, EndChatRequest.Builder>
{
	...
	public const int LastSessionMergeTimestampFieldNumber = 7;
	...
	public override int SerializedSize
	{
		get
		{
			...
			{
				num += CodedOutputStream.ComputeInt64Size(7, LastSessionMergeTimestamp);
			}
	...
	public override void WriteTo(CodedOutputStream output)
	{
		...
		if (HasLastSessionMergeTimestamp)
		{
			output.WriteInt64(7, LastSessionMergeTimestamp);
		}
