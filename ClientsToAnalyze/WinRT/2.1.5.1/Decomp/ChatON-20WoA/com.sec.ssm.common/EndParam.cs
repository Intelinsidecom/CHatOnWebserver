...
public sealed class EndParam : GeneratedMessage<EndParam, EndParam.Builder>
{
	public sealed class Builder : GeneratedBuilder<EndParam, Builder>
	{
		private EndParam result = new EndParam();

		protected override Builder ThisBuilder => this;

		protected override EndParam MessageBeingBuilt => result;

		public override MessageDescriptor DescriptorForType => Descriptor;

		public override EndParam DefaultInstanceForType => DefaultInstance;
		...
		public override EndParam BuildPartial()
		{
			if (result == null)
			{
		...
		{
			if (other is EndParam)
			{
				return MergeFrom((EndParam)other);
			}
			base.MergeFrom(other);
			return this;
		}

		public override Builder MergeFrom(EndParam other)
		{
	...
	public const int LastSessionMergeTimestampFieldNumber = 5;

	private static readonly EndParam defaultInstance;
	...
	public static EndParam DefaultInstance => defaultInstance;

	public override EndParam DefaultInstanceForType => defaultInstance;

	protected override EndParam ThisMessage => this;

	public static MessageDescriptor Descriptor => SSMGPB.internal__static_com_sec_ssm_common_EndParam__Descriptor;

	protected override FieldAccessorTable<EndParam, Builder> InternalFieldAccessors => SSMGPB.internal__static_com_sec_ssm_common_EndParam__FieldAccessorTable;
	...
	public override int SerializedSize
	{
		get
		{
			...
			{
				num += CodedOutputStream.ComputeInt64Size(5, LastSessionMergeTimestamp);
			}
	...
	public override void WriteTo(CodedOutputStream output)
	{
		...
		if (HasLastSessionMergeTimestamp)
		{
			output.WriteInt64(5, LastSessionMergeTimestamp);
		}
		UnknownFields.WriteTo(output);
	}

	public static EndParam ParseFrom(ByteString data)
	{
		return CreateBuilder().MergeFrom(data).BuildParsed();
	}

	public static EndParam ParseFrom(ByteString data, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
	}

	public static EndParam ParseFrom(byte[] data)
	{
		return CreateBuilder().MergeFrom(data).BuildParsed();
	}

	public static EndParam ParseFrom(byte[] data, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
	}

	public static EndParam ParseFrom(Stream input)
	{
		return CreateBuilder().MergeFrom(input).BuildParsed();
	}

	public static EndParam ParseFrom(Stream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}

	public static EndParam ParseDelimitedFrom(Stream input)
	{
		return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
	}

	public static EndParam ParseDelimitedFrom(Stream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
	}

	public static EndParam ParseFrom(CodedInputStream input)
	{
		return CreateBuilder().MergeFrom(input).BuildParsed();
	}

	public static EndParam ParseFrom(CodedInputStream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}
	...
	public static Builder CreateBuilder(EndParam prototype)
	{
