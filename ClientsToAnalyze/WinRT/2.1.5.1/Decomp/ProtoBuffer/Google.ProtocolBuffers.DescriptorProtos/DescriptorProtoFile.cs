...
public static class DescriptorProtoFile
{
	...
	static DescriptorProtoFile()
	{
		...
		FileDescriptor.InternalDescriptorAssigner descriptorAssigner = delegate(FileDescriptor root)
		{
			...
			internal__static_google_protobuf_FileOptions__FieldAccessorTable = new FieldAccessorTable<FileOptions, FileOptions.Builder>(internal__static_google_protobuf_FileOptions__Descriptor, new string[8] { "JavaPackage", "JavaOuterClassname", "JavaMultipleFiles", "OptimizeFor", "CcGenericServices", "JavaGenericServices", "PyGenericServices", "UninterpretedOption" });
			internal__static_google_protobuf_MessageOptions__Descriptor = Descriptor.MessageTypes[9];
			internal__static_google_protobuf_MessageOptions__FieldAccessorTable = new FieldAccessorTable<MessageOptions, MessageOptions.Builder>(internal__static_google_protobuf_MessageOptions__Descriptor, new string[3] { "MessageSetWireFormat", "NoStandardDescriptorAccessor", "UninterpretedOption" });
