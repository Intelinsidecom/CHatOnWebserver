...
{
	public sealed class Builder : ExtendableBuilder<EnumOptions, Builder>
	{
		private EnumOptions result = new EnumOptions();

		protected override Builder ThisBuilder => this;

		protected override EnumOptions MessageBeingBuilt => result;

		public override MessageDescriptor DescriptorForType => Descriptor;

		public override EnumOptions DefaultInstanceForType => DefaultInstance;
		...
		public override EnumOptions BuildPartial()
		{
			...
			EnumOptions enumOptions = result;
			result = null;
			return enumOptions;
		}
	...
	private static readonly EnumOptions defaultInstance;

	private PopsicleList<UninterpretedOption> uninterpretedOption_ = new PopsicleList<UninterpretedOption>();

	private int memoizedSerializedSize = -1;

	public static EnumOptions DefaultInstance => defaultInstance;

	public override EnumOptions DefaultInstanceForType => defaultInstance;

	protected override EnumOptions ThisMessage => this;

	public static MessageDescriptor Descriptor => DescriptorProtoFile.internal__static_google_protobuf_EnumOptions__Descriptor;

	protected override FieldAccessorTable<EnumOptions, Builder> InternalFieldAccessors => DescriptorProtoFile.internal__static_google_protobuf_EnumOptions__FieldAccessorTable;
