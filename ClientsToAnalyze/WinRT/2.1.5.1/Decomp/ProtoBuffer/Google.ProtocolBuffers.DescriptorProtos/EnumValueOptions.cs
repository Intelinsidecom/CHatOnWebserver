...
{
	public sealed class Builder : ExtendableBuilder<EnumValueOptions, Builder>
	{
		private EnumValueOptions result = new EnumValueOptions();

		protected override Builder ThisBuilder => this;

		protected override EnumValueOptions MessageBeingBuilt => result;

		public override MessageDescriptor DescriptorForType => Descriptor;

		public override EnumValueOptions DefaultInstanceForType => DefaultInstance;
		...
		public override EnumValueOptions BuildPartial()
		{
			...
			EnumValueOptions enumValueOptions = result;
			result = null;
	...
	private static readonly EnumValueOptions defaultInstance;

	private PopsicleList<UninterpretedOption> uninterpretedOption_ = new PopsicleList<UninterpretedOption>();

	private int memoizedSerializedSize = -1;

	public static EnumValueOptions DefaultInstance => defaultInstance;

	public override EnumValueOptions DefaultInstanceForType => defaultInstance;

	protected override EnumValueOptions ThisMessage => this;

	public static MessageDescriptor Descriptor => DescriptorProtoFile.internal__static_google_protobuf_EnumValueOptions__Descriptor;

	protected override FieldAccessorTable<EnumValueOptions, Builder> InternalFieldAccessors => DescriptorProtoFile.internal__static_google_protobuf_EnumValueOptions__FieldAccessorTable;
	...
	public static EnumValueOptions ParseFrom(CodedInputStream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}
