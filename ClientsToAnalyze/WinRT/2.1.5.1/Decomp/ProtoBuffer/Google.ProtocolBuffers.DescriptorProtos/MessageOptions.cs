...
public sealed class MessageOptions : ExtendableMessage<MessageOptions, MessageOptions.Builder>
{
	public sealed class Builder : ExtendableBuilder<MessageOptions, Builder>
	{
		...
		public bool HasNoStandardDescriptorAccessor => result.HasNoStandardDescriptorAccessor;
	...
	public bool HasNoStandardDescriptorAccessor => hasNoStandardDescriptorAccessor;

	public bool NoStandardDescriptorAccessor => noStandardDescriptorAccessor_;
	...
	public override int SerializedSize
	{
		get
		{
			...
			{
				num += CodedOutputStream.ComputeBoolSize(2, NoStandardDescriptorAccessor);
			}
			foreach (UninterpretedOption uninterpretedOption in UninterpretedOptionList)
			{
