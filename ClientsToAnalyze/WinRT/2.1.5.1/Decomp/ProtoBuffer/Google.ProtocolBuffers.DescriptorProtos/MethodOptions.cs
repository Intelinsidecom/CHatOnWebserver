...
{
	public sealed class Builder : ExtendableBuilder<MethodOptions, Builder>
	{
		private MethodOptions result = new MethodOptions();

		protected override Builder ThisBuilder => this;

		protected override MethodOptions MessageBeingBuilt => result;

		public override MessageDescriptor DescriptorForType => Descriptor;

		public override MethodOptions DefaultInstanceForType => DefaultInstance;
		...
		public override MethodOptions BuildPartial()
		{
			...
			MethodOptions methodOptions = result;
			result = null;
	...
	private static readonly MethodOptions defaultInstance;

	private PopsicleList<UninterpretedOption> uninterpretedOption_ = new PopsicleList<UninterpretedOption>();

	private int memoizedSerializedSize = -1;

	public static MethodOptions DefaultInstance => defaultInstance;

	public override MethodOptions DefaultInstanceForType => defaultInstance;

	protected override MethodOptions ThisMessage => this;

	public static MessageDescriptor Descriptor => DescriptorProtoFile.internal__static_google_protobuf_MethodOptions__Descriptor;

	protected override FieldAccessorTable<MethodOptions, Builder> InternalFieldAccessors => DescriptorProtoFile.internal__static_google_protobuf_MethodOptions__FieldAccessorTable;
	...
	public static MethodOptions ParseFrom(CodedInputStream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}
