...
public sealed class CodedOutputStream
{
	...
	public static int ComputeFieldSize(FieldType fieldType, int fieldNumber, object value)
	{
		return fieldType switch
		{
			...
			FieldType.Group => ComputeGroupSize(fieldNumber, (IMessageLite)value), 
			FieldType.Message => ComputeMessageSize(fieldNumber, (IMessageLite)value), 
			...
			FieldType.Enum => ComputeEnumSize(fieldNumber, ((IEnumLite)value).Number), 
	...
	public static int ComputeFieldSizeNoTag(FieldType fieldType, object value)
	{
		return fieldType switch
		{
			...
			FieldType.Group => ComputeGroupSizeNoTag((IMessageLite)value), 
			FieldType.Message => ComputeMessageSizeNoTag((IMessageLite)value), 
			...
			FieldType.Enum => ComputeEnumSizeNoTag(((IEnumLite)value).Number), 
			_ => throw new ArgumentOutOfRangeException("Invalid field type " + fieldType), 
		};
	}
