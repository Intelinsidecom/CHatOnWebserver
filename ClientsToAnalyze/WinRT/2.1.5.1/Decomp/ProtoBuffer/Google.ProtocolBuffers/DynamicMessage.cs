...
public sealed class DynamicMessage : AbstractMessage<DynamicMessage, DynamicMessage.Builder>
{
	public sealed class Builder : AbstractBuilder<DynamicMessage, Builder>
	{
		...
		public override bool IsInitialized => fields.IsInitializedWithRespectTo(type.Fields);
		...
		public override IDictionary<FieldDescriptor, object> AllFields => fields.AllFieldDescriptors;
	...
	public bool Initialized => fields.IsInitializedWithRespectTo(type.Fields);
