...
public sealed class ChatReply : GeneratedMessage<ChatReply, ChatReply.Builder>
{
	public sealed class Builder : GeneratedBuilder<ChatReply, Builder>
	{
		private ChatReply result = new ChatReply();

		protected override Builder ThisBuilder => this;

		protected override ChatReply MessageBeingBuilt => result;

		public override MessageDescriptor DescriptorForType => Descriptor;

		public override ChatReply DefaultInstanceForType => DefaultInstance;
		...
		public override ChatReply BuildPartial()
		{
			if (result == null)
			{
				throw new InvalidOperationException("build() has already been called on this Builder");
			}
			ChatReply chatReply = result;
			result = null;
			return chatReply;
		}
		...
		{
			if (other is ChatReply)
			{
				return MergeFrom((ChatReply)other);
			}
			base.MergeFrom(other);
			return this;
		}

		public override Builder MergeFrom(ChatReply other)
		{
	...
	public const int MsgReceivedTimeFieldNumber = 4;

	public const int ResultFieldNumber = 5;

	private static readonly ChatReply defaultInstance;
	...
	public static ChatReply DefaultInstance => defaultInstance;

	public override ChatReply DefaultInstanceForType => defaultInstance;

	protected override ChatReply ThisMessage => this;

	public static MessageDescriptor Descriptor => SSMGPB.internal__static_com_sec_ssm_common_ChatReply__Descriptor;

	protected override FieldAccessorTable<ChatReply, Builder> InternalFieldAccessors => SSMGPB.internal__static_com_sec_ssm_common_ChatReply__FieldAccessorTable;
	...
	public override int SerializedSize
	{
		get
		{
			...
			if (HasServerInfo)
			{
				num += CodedOutputStream.ComputeMessageSize(3, ServerInfo);
			}
			if (HasMsgReceivedTime)
			{
				num += CodedOutputStream.ComputeInt64Size(4, MsgReceivedTime);
			}
			if (HasResult)
			{
	...
	public override void WriteTo(CodedOutputStream output)
	{
		...
		if (HasServerInfo)
		{
			output.WriteMessage(3, ServerInfo);
		}
		if (HasMsgReceivedTime)
		{
			output.WriteInt64(4, MsgReceivedTime);
		}
		if (HasResult)
		{
	...
	public static ChatReply ParseFrom(ByteString data)
	{
		return CreateBuilder().MergeFrom(data).BuildParsed();
	}

	public static ChatReply ParseFrom(ByteString data, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
	}

	public static ChatReply ParseFrom(byte[] data)
	{
		return CreateBuilder().MergeFrom(data).BuildParsed();
	}

	public static ChatReply ParseFrom(byte[] data, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
	}

	public static ChatReply ParseFrom(Stream input)
	{
		return CreateBuilder().MergeFrom(input).BuildParsed();
	}

	public static ChatReply ParseFrom(Stream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}

	public static ChatReply ParseDelimitedFrom(Stream input)
	{
		return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
	}

	public static ChatReply ParseDelimitedFrom(Stream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
	}

	public static ChatReply ParseFrom(CodedInputStream input)
	{
		return CreateBuilder().MergeFrom(input).BuildParsed();
	}

	public static ChatReply ParseFrom(CodedInputStream input, ExtensionRegistry extensionRegistry)
	{
		return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
	}
	...
	public static Builder CreateBuilder(ChatReply prototype)
	{
