...
public abstract class ExtendableMessage<TMessage, TBuilder> : GeneratedMessage<TMessage, TBuilder> where TMessage : GeneratedMessage<TMessage, TBuilder> where TBuilder : GeneratedBuilder<TMessage, TBuilder>
{
	...
	{
		private readonly IEnumerator<KeyValuePair<FieldDescriptor, object>> iterator;

		private readonly FieldSet extensions;

		private KeyValuePair<FieldDescriptor, object>? next = null;
	...
	public override IDictionary<FieldDescriptor, object> AllFields
	{
		get
		{
			...
			foreach (KeyValuePair<FieldDescriptor, object> allField in extensions.AllFields)
			{
				mutableFieldMap[allField.Key] = allField.Value;
			}
