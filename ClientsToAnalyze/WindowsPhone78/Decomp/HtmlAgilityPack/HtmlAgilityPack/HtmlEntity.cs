...
public class HtmlEntity
{
	...
	public static string DeEntitize(string text)
	{
		...
		default:
		{
			...
			ParseState parseState = default(ParseState);
			StringBuilder stringBuilder = default(StringBuilder);
			int num2 = default(int);
			ParseState parseState2 = default(ParseState);
			...
			while (true)
			{
					...
					try
					{
						while (true)
						{
							...
							while (true)
							{
								...
								case 4:
								{
									int value2 = Convert.ToInt32(text3, fromBase);
				...
				case 21:
					...
					continue;
				case 19:
					num = ((stringBuilder2.Length != 0) ? 20 : 27);
					continue;
				case 2:
					return null;
				case 13:
				...
				case 20:
					if (stringBuilder2[0] != '#')
					{
						obj = _entityValue[stringBuilder2.ToString()];
						num = 10;
					}
					else
					{
				...
				case 16:
					...
					break;
				case 37:
					stringBuilder.Append(string.Concat("&", stringBuilder2, ";"));
					num = 0;
					continue;
				case 24:
					break;
	...
	public static HtmlNode Entitize(HtmlNode node)
	{
		...
		while (true)
		{
			...
			default:
				...
				htmlNode = node.CloneNode(deep: true);
				num = 10;
				continue;
			case 7:
			...
			case 6:
				...
				continue;
			case 5:
				num = ((!htmlNode.HasChildNodes) ? 9 : 7);
				continue;
			case 10:
	...
	{
		IEnumerator<HtmlAttribute> enumerator = ((IEnumerable<HtmlAttribute>)collection).GetEnumerator();
		try
		{
			int num = 2;
			while (true)
			{
				...
				case 3:
					if (enumerator.MoveNext())
					{
						...
						current.Value = Entitize(current.Value);
						num = 1;
					}
					else
					{
	...
	{
		IEnumerator<HtmlNode> enumerator = ((IEnumerable<HtmlNode>)collection).GetEnumerator();
		try
		{
			int num = 2;
			...
			while (true)
			{
				...
				{
				case 10:
					Entitize(current.Attributes);
					num = 1;
					break;
				case 7:
					((HtmlTextNode)current).Text = Entitize(((HtmlTextNode)current).Text, useNames: true, entitizeQuotAmpAndLtGt: true);
					num = 8;
					break;
				case 4:
