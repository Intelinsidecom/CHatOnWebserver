...
internal sealed class OpacityAnimator
{
	...
	public static void EnsureAnimator(UIElement targetElement, ref Microsoft.Phone.Controls.OpacityAnimator animator)
	{
		if (animator == null)
		{
			animator = new Microsoft.Phone.Controls.OpacityAnimator(targetElement);
		}
		if (animator == null)
		{
