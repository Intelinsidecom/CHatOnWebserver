...
public class vProperties
{
	...
	internal void COMPLETED(Property propval)
	{
		_completed = propval;
	...
	internal void DUE(Property propval)
	{
		_due = propval;
	...
	internal void DTEND(Property propval)
	{
		_dtend = propval;
	...
	internal void DTSTART(Property propval)
	{
		_dtstart = propval;
	...
	internal void CATEGORIES(Property propval)
	{
		_categories = propval;
		str_categories = _categories.Value.Split(';', ',');
	}

	internal void DESCRIPTION(Property propval)
	{
	...
	internal void SUMMARY(Property propval)
	{
		_summary = propval;
	...
	internal void LOCATION(Property propval)
	{
		_location = propval;
	...
	internal void STATUS(Property propval)
	{
	...
	internal void PRIORITY(Property propval)
	{
		_priority = propval;
		i_priority = Convert.ToInt32(_priority.Value);
	}

	internal void ATTENDEE(Property propval)
	{
	...
	internal void RDATE(Property propval)
	{
	...
	internal void GEO(Property propval)
	{
		gc_geo = null;
		_geo = propval;
	...
	internal void TZ(Property propval)
	{
		str_tz = null;
		_tz = propval;
	...
	internal void DAYLIGHT(Property propval)
	{
		dl_daylight = null;
		_daylight = propval;
